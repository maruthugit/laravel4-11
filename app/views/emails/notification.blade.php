        ...
        <div class="col-lg-12">
            <div class="panel panel-default" align="center">
                <div class="panel-heading">
                    <img moz-do-not-send="true" src="http://tmgrocer.com/email/img/logo.png" alt="Jocom" width="222" height="106">
                </div>
    ...
    <tbody class="">
        <tr class="">
            <td width="166" style="width: 166px; margin: 0px; padding: 0px" class="">
                <a href="http://www.tmgrocer.com/" title="tmGrocer" style="border: none; text-decoration: none" class="" target="_blank" rel="noreferrer"><img src="http://tmgrocer.com/sig/Signature_icon/20-01.png" alt="Jocom" style="border: none" class="">
                </a>
            </td>
