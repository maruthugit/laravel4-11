		...
		<div class="col-lg-12">
			<div class="panel panel-default" align="center">
				<div class="panel-heading">
					<h1 class="page-header text-primary"></i>FREE Coupon For You!</h1>
				</div>
				<div class="panel-body">
					...
					<p>
						Start shopping at tmGrocer and get RM10 off! Copy the following code and redeem during checkout.<br>
					</p>
