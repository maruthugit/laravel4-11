    ...
    <body>
        <table style="width:100%;">
            <tr>
                <td style="text-align:right;font-size: 18px;width: 45%;text-align: left;font-weight:light;" rowspan="2" valign="top">
                    ...
                    <br>JOCOM MSHOPPING SDN BHD
                    <br>Unit 9-1, Level 9, Tower 3, Avenue3,
                    <br>Bangsar South, No. 8 Jalan Kerinchi,
            ...
            <tr>
                <td style="text-align:right;font-size: 25px;width: 50%; text-align: center;font-weight: bold;" valign="top"><?php echo strtoupper($data['reference_number']); ?></td>
            </tr>
        ...
        <table style="width:100%; border-top: solid 3px #000;padding-top:10px;margin-top:10px;"> 
            ...
            <tr>
                <td style="text-align:left;font-size: 20px;font-weight:bolder;width:70%">
                    <?php echo $data['data_header']->delivery_addr_1; ?>
                    <?php if($data['data_header']->delivery_addr_2 != ''){  ?><br><?php echo $data['data_header']->delivery_addr_2; ?><?php } ?>
                    <br><?php echo $data['data_header']->delivery_city; ?>
                    <br><?php echo $data['data_header']->delivery_postcode; ?> <?php echo $data['data_header']->delivery_state; ?>, <?php echo $data['data_header']->delivery_country; ?>.
                </td>
                <td style="text-align:right;font-size: 35px;padding-right: 20px;font-weight:bolder;">MAL</td>
            </tr>
            <tr>
        ...
        <table style="width:100%; border-top: solid 3px #000;margin-top:10px;min-height: 150px;" cellspacing='0' border='0' > 
            <tr>
                ...
                <td style="text-align: right;font-weight: bold;padding-top:10px;font-size:25px;">Value (MYR)</td>
            </tr>
            <?php
            ...
            foreach($data['data_items'] as $key => $value) { 
                $totalAmount = $totalAmount + ($value->price * $value->unit);
            ?>
            <tr>
                <td style="border-right: solid 1px #000;font-size:20px;"><?php echo $value->product_name." ".$value->brand." ".$value->price_label; ?></td>
                <td style="text-align: right;font-size:20px;"><?php echo number_format((float)$value->price * $value->unit, 2, '.', '');?></td>
            </tr>
            <?php } ?>
                ...
                <? } } ?>
            <tr style="">
                <td style="text-align: left;font-weight: bold;border-top: solid 1px #000;padding-top:10px;font-size:25px;">Total Weight (KG): <?php echo number_format((float)$value->total_weight /1000, 2, '.', '');?></td>
        ...
        <table style="width:100%; border-top: solid 3px #000;padding-top:10px;margin-top:10px;"> 
            <tr>
                <td style="text-align:left;font-size: 20px;font-weight: bold">Contact : enquiries@jocom.my</td>
                <td style="text-align:left;font-size: 20px;font-weight: bold">+603 2241 6637</td>
            </tr>
        </table>
    </body>
</html>