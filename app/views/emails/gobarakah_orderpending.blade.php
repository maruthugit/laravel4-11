		...
		<div class="col-lg-12">
			<div class="panel panel-default" align="left">
				...
				<div class="panel-body">
					...
					<p>
						Thank you for your ordering with tmGrocer
					</p>
					<p>
					We wanted to let you know that your order <strong>{{$id}}</strong> is currently pending validation of your GoBarakah voucher and We will update you as soon as the order is confirmed
					</p>
					<div class="panel-body" align="left">
                        <?php echo isset($notify_body) ? $notify_body : 'Invalid request.';?>
                    </div>
					<p>GoBarakah Voucher Code: <strong>{{$gobarakah_voucher}}</strong></p>
					<p><br><br>
