		...
		<div class="col-lg-12">
			<div class="panel panel-default" align="left">
				<div class="panel-heading">
					<!--<h1 class="page-header text-primary"></i>Claim Your 1 Month FREE Laptop Rental</h1>-->
				</div>
				<div class="panel-body">
					...
					<p>
						Greetings from tmGrocer! 
					</p>
					<p>
						You have purchased order over RM150 on tmGrocer! And here's a FREE GIFT for you! <br><br>
						Insert this code when purchasing 12 months or 24 months subscription plan on <a href='http://www.smartrental.asia' title="Jocom" style="border:none;text-decoration:none;">www.smartrental.asia </a> to redeem 1 MONTH FREE LAPTOP RENTAL
					</p>
					<p>Gift Code: <strong>MFR1MO</strong></p>
					<p><br><br>
						Thank you for shopping with tmGrocer and hope to see you again!<br>
					</p>
					<p><br>Thank you!</p><br>
				</div>
