		...
		<div class="col-lg-12">
			<div class="panel panel-default" align="center">
				<div class="panel-heading">
					<h1 class="page-header text-primary"></i>Welcome to tmGrocer!</h1>
				</div>
				<div class="panel-body">
					...
					<p>
						Thank you for creating an account with tmGrocer. You can login using your username and password. <br>
                                                <?php if($email_activation == 1){ ?>
                                                You are require to activate your account before start shopping.<br>
                                                <?php } ?>
					</p>
                                        <br>
                                        <br>
                                        <?php if($email_activation == 1){ ?>
                                        <p><strong><a href="http://tmgrocer.com/accountactivation?user={{ $username }}&env={{$environment}}" style="font-size:25px;text-decoration: underline;">Activate Now!</a></strong></p>
					<?php } ?>
					<p><strong>Username: {{ $username }}</strong></p>
					<!--<p><strong>Password: {{ $password }}</strong></p>-->
					<p><br><br>
						Please do not hesitate to send us and email if you have any questions at enquiries@tmgrocer.com<br>
					</p>
					<p><br>Thank you!</p><br>
				</div>
