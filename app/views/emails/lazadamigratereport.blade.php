		...
		<div class="col-lg-12">
			<div class="panel panel-default" align="center">
				<div class="panel-heading">
					<h1 class="page-header text-primary"></i>Lazada Order Migration Report : <?php echo $acc_name; ?> </h1>
				</div>
                                    ...
                                    <table>
                                        <tr>
                                            <td style="padding:10px;" valign="top">
                                                 <table border="1">
                                                    <tr>
                                                        <td colspan="3"><strong>Manual Transfer Orders </strong></td> 
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    foreach ($manual_order_list as $key => $value) { 
                                                        $i = $i+1;
                                                    ?>
                                                    <tr>
                                            ...
                                            <td style="padding:10px;" valign="top">
                                                <table border="1">
                                                    <tr>
                                                        <td colspan="4"><strong>Successful Transfered Orders </strong></td> 
                                                    </tr>
                                                    <tr>
                                                        <td style="padding:5px;"><strong>S.No</strong></td>
                                                        <td style="padding:5px;"><strong>Order Number</strong></td>
                                                    ...
                                                    <?php 
                                                    $i = 0;
                                                    foreach ($transfered_orders as $keyT => $valueT) { 
                                                    $i = $i+1;	
                                                    ?>
                                                    <tr>
