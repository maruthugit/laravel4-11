...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add New eInvoice</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      {{ Form::open(['url' => 'einvoice/store', 'method' => 'post']) }}
                 <div class="form-horizontal">
                    <div class="form-group required {{ $errors->first('einv_date', 'has-error') }}">
                        <label  class="col-lg-2 control-label">eInvoice Date</label>
                        <div class="col-lg-2">
                            <div class='input-group date' id='datetimepicker1'>
                                <input type='text' class="form-control" name="einv_date"/>
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
                            {{ $errors->first('einv_date', '<p class="help-block">:message</p>') }}
                        </div>
                    </div>
                    <input type="hidden" name="grn_id" value="{{$grn->grn_id}}">
                    <div class="form-group">
                        {{ Form::label('po_no', 'PO No', array('class'=> 'col-lg-2 control-label')) }}
                        <input type="hidden" id="po_id" name="po_id" value="{{$grn->po_id}}">
                        <div class="col-lg-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-3">
                                    @if ($grn->discount_percent == 0.00 && $grn->discount_total == 0.00)
                                        {{ Form::checkbox('discchk', null, false, ['id' => 'discchk']) }}
                                    @else
                                        {{ Form::checkbox('discchk', null, true, ['id' => 'discchk']) }}
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    @if ($grn->discount_percent == 0.00 && $grn->discount_total == 0.00)
                                        {{ Form::number('discpercent', $grn->discount_percent, ['class' => 'form-control', 'readonly']) }}
                                    @else
                                        {{ Form::number('discpercent', $grn->discount_percent, ['class' => 'form-control']) }}
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    {{ Form::text('disctotal', $grn->discount_total, ['class' => 'form-control', 'readonly']) }}
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                {{ Form::text('whloc_name', $grn->name, array('class'=> 'form-control', 'autofocus' => 'autofocus', 'readonly' => 'readonly')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                {{ Form::text('whloc_address1', $grn->address1, array('class'=> 'form-control', 'autofocus' => 'autofocus', 'readonly' => 'readonly')) }}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                {{ Form::text('whloc_address2', $grn->address2, array('class'=> 'form-control', 'autofocus' => 'autofocus', 'readonly' => 'readonly')) }}
                            </div>
                        </div>
