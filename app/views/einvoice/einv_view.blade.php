...
$file = (Config::get('constants.EINV_PDF_FILE_PATH') . '/' . urlencode($einv['einv_no']) . '.pdf')."#".($einv['einv_id']).'#'.$einv['einv_no'];
...
?>
        ...
        <table class="page_footer">
            <tr>
                <td style="width: 100%; text-align: right">
                    Page [[page_cu]]/[[page_nb]] ({{ $display_details['einv_no'] }})
                </td>
            </tr>
        </table>
    </page_footer> -->
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 30%;">
                <font size="3"><strong>eInvoice</strong></font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 30%;" class="address_container">
                eInvoicce No: {{$einv['einv_no']}}<br>
                eInvoicce Date: <?php echo date_format(date_create($einv['einv_date']), 'Y-m-d'); ?><br>
                PO No: {{$einv['po_no']}}<br>
            </td>
        </tr>
    ...
    <table border="1" cellpadding="5" style="width: 100%;" class="address_container">
        ...
        ?>
        @if ($einv['discount_percent'] != 0 && $einv['discount_total'] != 0.00)
            <tr>
            ...
            <tr>
                ...
                <td align="right" class="address_container"><b>{{$po['discount_total']}}</b></td>
            </tr>
        @else
            <tr>
                <td colspan="5" style="border-top: 0px;text-align: left;" class="address_container"><b>Grand Total</b></td>
...
<a href="<?php echo '/einvoice/download/'.$encrypted?>"><button id="download">Download</button></a>
