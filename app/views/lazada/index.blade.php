...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
           <h1 class="page-header">Lazada Orders</h1>
...
<!--                        <div class="input-group " >
                    ...
                    <div class="col-md-2">
                        <?php if (in_array(Session::get('username'), array('joshua', 'agnes', 'maruthu','asif','queenie.wh','boobalan'), true ) ) {  ?>
                    ...
                    <div class="col-md-2 ">
                        <div class="btn-group btn-group pull-right" role="group" aria-label="Small button group"> 
                            ...
                            <!--<button type="button" class="btn btn-default active btn-acc" acc-type="1" data-toggle="popover" data-trigger="hover" data-placement="top" title="11Street Account" data-content="(elevenstreet@jocom.my)">F&N</button> -->
                            <button type="button" class="btn btn-default btn-acc" acc-type="2" data-toggle="popover" data-trigger="hover" data-placement="top" title="11Street Account" data-content="(elevenstreet2@jocom.my)">JOCOM</button> 
                            <button type="button" class="btn btn-default btn-acc" acc-type="3" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(etika@jocom.my)">ETIKA</button> 
                            <button type="button" class="btn btn-default btn-acc" acc-type="4" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(yeos@jocom.my)">YEOS</button> 
                            <button type="button" class="btn btn-default btn-acc" acc-type="5" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(starbucks@jocom.my)">STARBUCKS</button>
                            <button type="button" class="btn btn-default btn-acc" acc-type="6" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(pokka@jocom.my)">POKKA</button>
                            <button type="button" class="btn btn-default btn-acc" acc-type="7" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(ebfrozen@jocom.my)">EBFROZEN</button>
                            <button type="button" class="btn btn-default btn-acc" acc-type="8" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(everbest@jocom.my)">EVERBEST</button>
                            <button type="button" class="btn btn-default btn-acc" acc-type="9" data-toggle="popover" data-trigger="hover" data-placement="top" title="Lazada Account" data-content="(operation@jocom.my)">JOCOM EXPRESS</button>
                        </div>
                    </div>
        </div>
        <!-- /.col-lg-12 -->
    ...
    $('#dataTables-driver').dataTable({
        ...
        "columns" : [
            ...
            },
            {
               ...
               data: function ( row, type, val, meta ) {
               var TransferUrl = '/transaction/add/2/' +row.id ;
               var createCustomerURL = '/customer/create/1/'+row.id;
               var editUrl = '/transaction/edit/'+row.transaction_id;
                    if(row.status == 1){ 
                    var content =  '<a href=" '+TransferUrl+'"  target="_blank"><button type="button" class="btn btn-primary" style="margin-right:5px;"> Transfer</button></a>';
                        return content;
                    }
                    
                    if(row.status == 2){ 
                    var content =  '<a href="'+editUrl+'"><button type="button" class="btn btn-primary" style="margin-right:5px;"><i class="fa fa-pencil"></i></button></a>';
                        return content;
                    }
                },
                className: "center"
