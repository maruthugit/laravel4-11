...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Event/Camping Banner Type
                 <span class="pull-right">
                    ...
                    <a class="pull-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="/jocommy/eventnew"><i class="fa fa-plus"></i></a>
                    @endif
                </span>
            </h1>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('banner_type', array_merge(['any' => 'Any'], $banner_type), Input::get('banner_type'), ['id' => 'banner_type', 'class' => 'form-control', 'tabindex' => 2]) }}
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> Event/Camping List</h3>
                </div>
                <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-products">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-3">Event/Camping Name</th>
                                    <th class="col-md-1">Status</th>
                                    <th class="col-md-1">Start at</th>
                                    <th class="col-md-1">End at</th>
                                    <th class="col-md-1">Banner Type</th>
...
@section('script')
    $('#dataTables-products').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "{{ URL::to('jocommy/event?' . http_build_query(Input::all())) }}",
            "type": "POST"
        },
        "order" : [[ 0, 'desc' ]],
        "columnDefs" : [{
        ...
        "columns" : [
            ...
            { "data" : "5", "className": "text-right", "searchable" : false, "orderable" : false },
            { "data" : "6", "className": "text-right", "searchable" : false, "orderable" : false },
