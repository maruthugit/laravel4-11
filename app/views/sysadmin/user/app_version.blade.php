...
<div id="page-wrapper">
	...
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class='fa fa-gears'></i> Apps Version</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
	...
	{{ Form::open(array('url' => array('user/appupdate/') , 'class' => 'form-horizontal', 'method' => 'PUT')) }}
		...
		<div class="panel-body">
			<div class="col-lg-12">
				...
				<div class='form-group'>
					...
					<div class="col-lg-3">
					{{ Form::text('android', $app->android, ['placeholder' => ' UserName', 'class' => 'form-control']) }}
					</div>
				</div>
				<div class='form-group'>
