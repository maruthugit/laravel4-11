...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Manage Apps Version</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="panel panel-default">
        ...
        {{ Form::open(array('url' => array('sysadmin/appnew/update') , 'class' => 'form-horizontal', 'method' => 'PUT')) }}
                    ...
                    <div class="panel with-nav-tabs panel-default">
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane fade in @if ($count == 0) active @endif" id="tabandroid">
                                        <div class="col-lg-12">
...
<script>
    ...
    $(document).ready(function(){
            ...
            $('#dataTables-apphistory').dataTable({
                    ...
                    "processing": true,
                    "serverSide": true,
                    "ajax": "{{ URL::to('sysadmin/appnew/apphistory?'.http_build_query(Input::all())) }}",
                    "order" : [[ 0, 'desc' ]],
                    "columnDefs" : [{
                        "targets" : "_all",
                        "defaultContent" : "",
