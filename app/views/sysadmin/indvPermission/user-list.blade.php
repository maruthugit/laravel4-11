...
<body>
    ...
    <div class="wrapper">
        <div id="page-wrapper" style="margin: 0">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Individual Permission - Select User</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#dataTables-users').dataTable({
                "processing" : true,
                "serverSide" : true,
                "ajax" : "{{ URL::to('sysadmin/indvPermission/ajaxfetchuser') }}",
                "order" : [[0,'asc']],
                "lengthMenu" : [ 10 ],
                "bLengthChange" : false,
                "columnDefs" : [{
            ...
            $(document).on("click", "#selectUser", function() {
                ...
                parent.$('input#user_id').val(localStorage.data0);
                parent.$('input#username').val(localStorage.data1);
                parent.$('input#user_full_name').val(localStorage.data2);
                parent.$('input#user_email').val(localStorage.data3);
                parent.$('input#role_id').val(localStorage.data4);
                parent.$('input#role').val(localStorage.data5);
