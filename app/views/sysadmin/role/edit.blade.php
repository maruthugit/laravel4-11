...
<div id="page-wrapper">
    ...
    {{ Form::open(array('url' => array('sysadmin/role/update/' . $role->id ) , 'class' => 'form-horizontal', 'method' => 'PUT')) }}
        ...
        <div class="panel-body">
            <div class="col-lg-10">
                <div class='form-group'>
                    {{ Form::label('role_name', 'Role Name', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-4">
