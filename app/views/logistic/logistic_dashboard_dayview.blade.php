...
<div id="page-wrapper">
 <div class="container-fluid">
             <div class="panel panel-default">
                <div class="panelheading bg_lb"><span class="font-weight-bold1" style="width:50%; float:left;">Logistic Dashboard : Overall Statistics</span>
                      <span class="font-weight-bold1" style="vertical-align: top;">Overall Batch Pending 
                  ...
                  <table class="able bg_lb table-bordered panelheading" style="width:100%; color:#FFF;">
                          <tbody class="mySlides" style="width:100%;">
                            ...
                            <tbody class="mySlides" style="width:100%;">
                              ...
                              <!--  <tr id="contentpendingrow2" style="background:#FFFFFF; width:100%;">
...
<i class="fa fa-square fa-2x" aria-hidden="true" style="color:#458224; vertical-align:middle;"></i> SENT  &nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-square fa-2x" style="color:#ED2536; vertical-align:middle;" aria-hidden="true"></i> RETURNED/CANCELLED      </span></div>
                </div>
