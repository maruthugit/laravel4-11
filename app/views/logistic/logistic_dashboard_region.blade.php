...
<body>
<div id="page-wrapper" class="scroller">
               ...
               <div class="panel panel-default" tyle="width:100%;">
                  <table class="able bg_lb table-bordered panelheading" style="width:100%; color:#FFF;">
                          <tbody class="mySlides" style="width:100%;" id='block1'>
                            ...
                            <tbody class="mySlides" style="width:100%;" id='block3_1'>
                              <tr id="headingrow2_1" style="align:center; width:100%;" width="100%">
                              </tr>
                              <tr id="contentrow2_1" style="background:#FFFFFF; width:100%;" width="100%">
                              </tr>  
                             </tbody>
                            ...
                            <!-- Returned Transaction Start -->
                              <tbody class="mySlides" style="width:100%;" id='block9'>
                                <tr id="headingrow2_2" style="align:center; background:#FF0000; width:100%;">
                                </tr>
                                <tr id="contentrow2_2" style="background:#FFFFFF; width:100%;">
                                </tr>  
                             </tbody>
                            
                             <!-- Returned Transaction End -->
                             
                             <!-- PartialSent Transaction Start -->
                             <tbody class="mySlides" style="width:100%;" id='block10'>
                                <tr id="headingrow2_3" style="align:center; background:#FF0000; width:100%;">
                                </tr>
                                <tr id="contentrow2_3" style="background:#FFFFFF; width:100%;">
                                </tr>  
                             </tbody>
                             <!-- PartialSent Transaction End -->
                            
                             <!-- LineClear, Ta Q Bin & Over 60Days Transactions Start -->
                             <tbody class="mySlides" style="width:100%;" id='block7'>
                              <tr id="headingrow6" style="align:center; background:#FF0000; width:100%;">
                              </tr>
                              <tr id="contentrow6" style="background:#FFFFFF; width:100%;">
                              </tr>  
                             </tbody>

                             <tbody class="mySlides" style="width:100%;" id='block8'>
                              <tr id="headingrow7" style="align:center; background:#FF0000; width:100%;">
                              </tr>
                              <tr id="contentrow7" style="background:#FFFFFF; width:100%;">
                              </tr>  
                             </tbody>

                             
                             <!--  LineClear, Ta Q Bin & Over 60Days Transactions End -->
...
$(document).ready(function() {
    ...
    function getStatistic(){
        ...
        $.ajax({
            ...
            success: function(data) {
                 ...
                 if(blockcount<=3){
                   ...
                   $('#block3_1').removeClass('mySlides');
                   $('#block2').find('tbody').hide();
                   $('#block3').find('tbody').hide();
                   $('#block3_1').find('tbody').hide();
                 }
                 ...
                 $.each(data.data.TransactionLogistic.DriverDetails, function (index, value) {
                   ...
                   headinglist1 = headinglist1 +  "<tr><th align='center' valign='bottom' class='text-uppercase text-center listheight'>TRANSACTION ID</th></th></table></th>";   
                    ...
                    else if(itneary>=7 && itneary<=9){
                      headinglist2_1 = headinglist2_1 + "<th class='text-uppercase text-center' align='center'><span class='absolute'>"+ (itneary==7?value.regionname:'')+"</span><table width='100%' border=0><tr style='background:"+value.colorlight+"'><th align='center' class='text-uppercase text-center listheight col-centered' width='33%' style='align:center;'><span class='font-weight'>TEAM "+value.drivername+"</span><br><span class='circle-icon' aria-hidden='true' style='background:"+value.colordark+"; color:#fff;'><span class='font-weight'>"+value.teamseque+"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>";
                   headinglist2_1 = headinglist2_1 +  "<tr><th align='center' valign='bottom' class='text-uppercase text-center listheight'>TRANSACTION ID</th></th></table></th>";   
                    }
                    else if(itneary>=10){
                      headinglist2 = headinglist2 + "<th class='text-uppercase text-center' align='center'><span class='absolute'>"+ (itneary==10?value.regionname:'')+"</span><table width='100%' border=0><tr style='background:"+value.colorlight+"'><th align='center' class='text-uppercase text-center listheight col-centered' width='33%' style='align:center;'><span class='font-weight'>TEAM "+value.drivername+"</span><br><span class='circle-icon' aria-hidden='true' style='background:"+value.colordark+"; color:#fff;'><span class='font-weight'>"+value.teamseque+"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>";
                 ...
                 $("#headingrow2_1").html(headinglist2_1);  
                ...
                var rowlist1 = 0;
                // console.log(data.data.TransactionLogistic.DriverDetails);
                 $.each(data.data.TransactionLogistic.DriverDetails, function (index1, value1) {
                            ...
                            if(tneary1<=3){
                                    ...
                                    $.each(data.data.TransactionLogistic.BatchDetails, function(indexBat, valbat){
                                        ...
                                        if(value1.driverid == valbat.driver_id)
                                        {
                                          ...
                                          rowlist=rowlist+1;
                                            ...
                                            contentlist = contentlist + "<span style='color:"+valbat.transcolor+"; font-size:30pt;'><strong>"+valbat.transactionid+"</strong></span> <br>";
                                    ...
                                    $.each(data.data.TransactionLogistic.BatchDetails, function(indexBat, valbat){
                                        ...
                                        if(value1.driverid == valbat.driver_id)
                                        {
                                          ...
                                          rowlist=rowlist+1;
                                            ...
                                            contentlist1 = contentlist1 + "<span style='color:"+valbat.transcolor+"; font-size:30pt;'><strong>"+valbat.transactionid+"</strong></span> <br>";
                            ...
                            else if(tneary1>=7 && tneary1<=9){
                                    contentlist2_1 = contentlist2_1 + "<td valign='top' class='text-uppercase text-center'  style='border:1px solid #000;' height='600px;' width='550px' align='center'><table width='100%' border=0><tr><td valign='top' align='center' class='text-uppercase text-center' style='align:center;'>";
                                    ...
                                    $.each(data.data.TransactionLogistic.BatchDetails, function(indexBat, valbat){
                                        ...
                                        if(value1.driverid == valbat.driver_id)
                                        {
                                          ...
                                          rowlist=rowlist+1;
                                            ...
                                            contentlist2_1 = contentlist2_1 + "<span style='color:"+valbat.transcolor+"; font-size:30pt;'><strong>"+valbat.transactionid+"</strong></span> <br>";

                                            if(rowlist==16){
                                                 rowlist = 0;
                                                 contentlist2_1 = contentlist2_1 + "</td><td valign='top' align='center' class='text-uppercase text-center' style='align:center; border-left:1px dashed #333'>";
                                            }
                                    ...
                                    if(rowbreak ==0){
                                       ...
                                       contentlist2_1 = contentlist2_1 + "<br><span style='color:#000;'>No Records Found</span>";

                                    }
                                     contentlist2_1 = contentlist2_1 + "</td></tr></table></td>"; 

                                     $("#contentrow2_1").html(contentlist2_1);  
                                    ...
                                    $.each(data.data.TransactionLogistic.BatchDetails, function(indexBat, valbat){
                                        ...
                                        if(value1.driverid == valbat.driver_id)
                                        {
                                          ...
                                          rowlist=rowlist+1;
                                            ...
                                            contentlist2 = contentlist2 + "<span style='color:"+valbat.transcolor+"; font-size:30pt;'><strong>"+valbat.transactionid+"</strong></span> <br>";
                        ...
                        //                     contentlist = contentlist + "<span style='color:"+val.transcolor+"; font-size:24pt;'><strong>"+val.transactionid+"</strong></span> <br>";
                        ...
                        //                       contentlist1 = contentlist1 + "<span style='color:"+val1.transcolor+"; font-size:24pt;'><strong>"+val1.transactionid+"</strong></span> <br>";
        ...
        //           rowlist4 = 0;
        //           rowlist5 = 0;
        //             if (typeof(data.tdata.Transactionpending) != 'undefined' && typeof(data.tdata.Transactionpending.Regionlist) != 'undefined'){
        ...
        //             }
        //              rcount = regioncount;
        //               console.log('RegionList '+ regioncount);
        //              if(regioncount==1){
        ...
        //               if(regioncount == 1){
        //               headinglist3 = headinglist3 + "<th class='text-uppercase text-center tablewidth' align='center'><table border=0 class='tablewidth'><tr><th class='text-uppercase  listheight'  style='align:left;'><span class='font-weight'>&nbsp;&nbsp;&nbsp;"+value.regionname+" :: Unassigned Transactions <span style='color:#CEEFF3'>("+value.countpending+")</span> &nbsp;&nbsp;&nbsp;</span></th>";
        //               }
        ...
        //             if(typeof(data.tdata.Transactionpending) != 'undefined' && typeof(data.tdata.Transactionpending.Transactinlist) != 'undefined') {
        ...
        //                  if(regioncount == 1) {
        //                   rowlist3=rowlist3+1;
        //                   contentlist3 = contentlist3 + "<span style='color:#000; font-size:25pt;'><strong>"+value5.transactionid+"</strong></span> <br>";
        ...
        //                         rowlist4 = rowlist4 +1;
        //                       contentlist4 = contentlist4 + "<span style='color:#000; font-size:25pt;'><strong>"+value5.transactionid+"</strong></span> <br>";
        ...
        //                         rowlist5 = rowlist5 +1;
        //                       contentlist5 = contentlist5 + "<span style='color:#000; font-size:25pt;'><strong>"+value5.transactionid+"</strong></span> <br>";
        ...
        //   });
          ...
          //TaQBin&LineClear Transaction Start 
            headingrow6 = "";
            ...
            $.ajax({
              method: "POST",
              url: "/jlogistic/couriertransaction",
              dataType:'json',
              data: { 
              ...
              success: function(data) {
                  ...
                  // console.log(data); 
                   ...
                   var cpendings = data.data.TransactionLineclear.cpending;
                   var regioncount = data.data.TransactionLineclear.regionid; 
                     rcount = regioncount;
                   //   alert(cpendings+regioncount);
                     if(regioncount!=1){
                       $('#block7').removeClass('mySlides');
                       $('#block7').find('tbody').hide();
                     }
                     
                     
                      headingrow6 = headingrow6 + "<th class='text-uppercase text-center tablewidth' align='center'><table border=0 class='tablewidth'><tr><th class='text-uppercase  listheight'  style='align:left;'><span class='font-weight'>&nbsp;&nbsp;&nbsp; Ta Q Bin / LineClear Transactions <span style='color:#CEEFF3'>("+cpendings+")</span> &nbsp;&nbsp;&nbsp;</span></th>";

                    

                    
                      $("#headingrow6").html(headingrow6);  

                    contentlist6 = contentlist6 + "<td valign='top' class='text-uppercase text-center' style='border:1px solid #000; width:100%;' height='600px' align='center'><table style='width:100%; min-height:600px;' height='600px' border=0><tr><td valign='top' align='center'  class='text-uppercase text-center' style='align:center;'>";

                    // console.log(data.tdata.Transactionpending.Transactinlist);

                    $.each(data.data.TransactionLineclear.TalineDetails, function (index, value5) {

                        // console.log('EE'+value5.regionid+'EE');  
    
                         if(value5 != null && value5.transactionid != null) {
                          rowlist3=rowlist3+1;
                           contentlist6 = contentlist6 + "<span style='color:#000; font-size:30pt;'><strong>"+value5.transactionid+"</strong></span> <br>";

                                    if(rowlist3==25){
                                       rowlist3 = 0;
                                       contentlist6 = contentlist6 + "</td><td valign='top' align='center' class='text-uppercase text-center' style='align:center; border-left:1px dashed #333'>";
                                  }
                      ...
                      if(rowlist3 ==0){
                           ...
                           contentlist6 = contentlist6 + "<br><span style='color:#000; text-align:center;'>No Records Found</span><br><br>";

                        }

                       contentlist6 = contentlist6 + "</td></tr></table></td>"; 
                       $("#contentrow6").html(contentlist6);  
          ...
          //TaQBin&LineClear Transaction End 


          //Over 60days Transaction Start 
               
              
            $.ajax({
              method: "POST",
              url: "/jlogistic/over60daystransaction",
              dataType:'json',
              data: { 
              ...
              success: function(data) {
                   ...
                   var cpendings60 = data.data.TransactionLineclear.cpending60;
                   var regioncount = data.data.TransactionLineclear.regionid; 
                     rcount = regioncount;
                     
                     
                      headingrow7 = headingrow7 + "<th class='text-uppercase text-center tablewidth' align='center'><table border=0 class='tablewidth'><tr><th class='text-uppercase  listheight'  style='align:left;'><span class='font-weight'>&nbsp;&nbsp;&nbsp; Over 7 Days Pending Transactions <span style='color:#CEEFF3'></span> &nbsp;&nbsp;&nbsp;</span></th>";

                    

                    
                      $("#headingrow7").html(headingrow7);  

                    contentlist7 = contentlist7 + "<td valign='top' class='text-uppercase text-center' style='border:1px solid #000; width:100%;' height='600px' align='center'><table style='width:100%; min-height:600px;' height='600px' border=0><tr><td valign='top' align='center'  class='text-uppercase text-center' style='align:center;'>";

                    // console.log(data.tdata.Transactionpending.Transactinlist);
                    if(data.data.TransactionLineclear != null && data.data.TransactionLineclear.Over60daysDetails != null) {
                    $.each(data.data.TransactionLineclear.Over60daysDetails, function (index, value5) {

                        // console.log('EE'+value5.regionid+'EE');  
    
                         if(value5 != null && value5.transactionid != null) {
                          rowlist3=rowlist3+1;
                           contentlist7 = contentlist7 + "<span style='color:#000; font-size:30pt;'><strong>"+value5.transactionid+"</strong></span> <br>";

                                    if(rowlist3==25){
                                       rowlist3 = 0;
                                       contentlist7 = contentlist7 + "</td><td valign='top' align='center' class='text-uppercase text-center' style='align:center; border-left:1px dashed #333'>";
                                  }
                      ...
                      if(rowlist3 ==0){
                           ...
                           contentlist7 = contentlist7 + "<br><span style='color:#000; text-align:center;'>No Records Found</span><br><br>";

                        }

                       contentlist7 = contentlist7 + "</td></tr></table></td>"; 
                       $("#contentrow7").html(contentlist7);  
          ...
          //over 60days Transaction End 
          
          //Returned Transaction Start 

            $.ajax({
              method: "POST",
              url: "/jlogistic/returnedtransaction",
              dataType:'json',
              data: { 
              ...
              success: function(data) {
                   ...
                   var creturn = data.data.TransactionReturned.creturned;
                   var regioncount = data.data.TransactionReturned.regionid; 
                     rcount = regioncount;
                     
                     
                      headingrow2_2 = headingrow2_2 + "<th class='text-uppercase text-center tablewidth' align='center'><table border=0 class='tablewidth'><tr><th class='text-uppercase  listheight'  style='align:left;'><span class='font-weight'>&nbsp;&nbsp;&nbsp; Returned Transactions <span style='color:#CEEFF3'>("+creturn+")</span> &nbsp;&nbsp;&nbsp;</span></th>";

                    

                    
                      $("#headingrow2_2").html(headingrow2_2);  

                    contentrow2_2 = contentrow2_2 + "<td valign='top' class='text-uppercase text-center' style='border:1px solid #000; width:100%;' height='600px' align='center'><table style='width:100%; min-height:600px;' height='600px' border=0><tr><td valign='top' align='center'  class='text-uppercase text-center' style='align:center;'>";

                    // console.log(data.tdata.Transactionpending.Transactinlist);

                    $.each(data.data.TransactionReturned.ReturnedDetails, function (index, value6) {

                        // console.log('EE'+value6.transactionid+'EE');  

                         
                          rowlist3=rowlist3+1;
                           contentrow2_2 = contentrow2_2 + "<span style='color:#000; font-size:30pt;'><strong>"+value6.transactionid+"</strong></span> <br>";

                                    if(rowlist3==25){
                                       rowlist3 = 0;
                                       contentrow2_2 = contentrow2_2 + "</td><td valign='top' align='center' class='text-uppercase text-center' style='align:center; border-left:1px dashed #333'>";
                                  }
                      ...
                      if(rowlist3 ==0){
                           ...
                           contentrow2_2 = contentrow2_2 + "<br><span style='color:#000; text-align:center;'>No Records Found</span><br><br>";

                        }

                       contentrow2_2 = contentrow2_2 + "</td></tr></table></td>"; 
                       $("#contentrow2_2").html(contentrow2_2);  
          ...
          //Partial Sent Transaction Start 

            $.ajax({
              method: "POST",
              url: "/jlogistic/partialsenttransaction",
              dataType:'json',
              data: { 
              ...
              success: function(data) {
                   ...
                   var cpartial = data.data.TransactionPartialSent.cpartialsent;
                   var regioncount = data.data.TransactionPartialSent.regionid; 
                     rcount = regioncount;
                     
                     
                      headingrow2_3 = headingrow2_3 + "<th class='text-uppercase text-center tablewidth' align='center'><table border=0 class='tablewidth'><tr><th class='text-uppercase  listheight'  style='align:left;'><span class='font-weight'>&nbsp;&nbsp;&nbsp; Partial Sent Transactions <span style='color:#CEEFF3'>("+cpartial+")</span> &nbsp;&nbsp;&nbsp;</span></th>";

                    

                    
                      $("#headingrow2_3").html(headingrow2_3);  

                    contentrow2_3 = contentrow2_3 + "<td valign='top' class='text-uppercase text-center' style='border:1px solid #000; width:100%;' height='600px' align='center'><table style='width:100%; min-height:600px;' height='600px' border=0><tr><td valign='top' align='center'  class='text-uppercase text-center' style='align:center;'>";
                    

                    $.each(data.data.TransactionPartialSent.PartialSentDetails, function (index, value7) {

                        // console.log('EE'+value5.transactionid+'EE');  
    
                         if(value7 != null && value7.transactionid != null) {
                             
                          rowlist3=rowlist3+1;
                           contentrow2_3 = contentrow2_3 + "<span style='color:#000; font-size:30pt;'><strong>"+value7.transactionid+"</strong></span> <br>";

                                    if(rowlist3==25){
                                       rowlist3 = 0;
                                       contentrow2_3 = contentrow2_3 + "</td><td valign='top' align='center' class='text-uppercase text-center' style='align:center; border-left:1px dashed #333'>";
                                  }
                      ...
                      if(rowlist3 ==0){
                           ...
                           contentrow2_3 = contentrow2_3 + "<br><span style='color:#000; text-align:center;'>No Records Found</span><br><br>";

                        }

                       contentrow2_3 = contentrow2_3 + "</td></tr></table></td>"; 
                       $("#contentrow2_3").html(contentrow2_3);  
