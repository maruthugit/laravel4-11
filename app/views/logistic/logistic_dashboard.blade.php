...
<div id="page-wrapper">
        ...
        <div class="row" style="margin-top:20px;">
            <div class="col-md-12" style="">
                <div class="panel panel-default" style="margin-top:20px;">
                    <div class="panel-heading">Total Batch Sent</div>
    ...
    <!-- Region -->
            ...
            <div class="row" style="margin-top:20px;min-height:510px;">
                <div class="col-md-12" style="min-height:500px;">
                    <div class="panel panel-default" style="margin-top:20px;">
                        <div class="panel-heading">Total Batch Sent</div>
                        <div class="panel-body">
                          <div id="myChartRegion" style="max-height:450px;"></div>
                        </div>
                    </div>
                </div>
            </div>
...
//                console.log($("#total-logistic-sending").html(data.data.TotalStatistic.TransactionLogistic.Sending));
                ...
                $("#myChart").css('height', 75 * data.data.TotalStatistic.driverBatch.TotalBatchSentGrouping.length + 25);
                <?php if($region_id==0){ ?>
