...
@section('title') Dynamic Panel Management @stop
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Jocom Dynamic Panel Management
            <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}jcmdynamicsale/edit/<?php echo $flash->id; ?>"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-default" data-toggle="tooltip" href="{{asset('/')}}jcmdynamicsale"><i class="fa fa-reply"></i></a>
            </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url'=>'jcmdynamicsale/update/'.$flash->id , 'class' => 'form-horizontal form-submit', 'files' => true, 'enctype' => "multipart/form-data")) }}
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                 ...
                 {{ Form::label('main_title', 'Main Title', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-6">
                    <input type="text" id="main_title" name="main_title" class="form-control" value="{{$flash->main_title}}" required = 'required'> 
                </div> 
                </div>
                <div class='form-group'>
             ...
             <div class="form-group">
                <div class="col-lg-6" >
                <label for="banner_filename" class="col-lg-4 control-label">Banner Image (Resolution 640X300)</label>
                    <div class="input-group">
                                            <input type="file" class="form-control" id="banner_filename" name="banner_filename" onchange="FileOnChange(event)" accept="image/gif, image/jpeg, image/png">
                                            <input type="hidden" class="form-control" name="limgref[]" value="">
                                            @if($flash->banner_filename!="")
                                            <img id="previewIMG" style="width: 100%;margin-top: 10px;" src="{{asset('dynamic/images')}}/{{$flash->banner_filename}}">
                                            @endif
                                        </div>
                                        </div>
                                        </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <span class="pull-left"><button id="addProdBtn" name="addProdBtn" class="btn btn-primary addProdBtn" data-toggle="tooltip" href="/jcmdynamicsale/ajaxproduct"><i class="fa fa-plus"></i> Add Product</span>
                                        </div>
                                    </div>
                                    <br />
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="cell-small col-sm-1">Qty Sold</th>
                                                <th class="cell-small col-sm-1">Limit Quantity</th>
                                        ...
                                        <tbody id="ptb">
                                            ...
                                            <tr class="product">
                                                ...
                                                <td class="text-center col-xs-1"><input type="text" name="qty[]" value="{{$pkg->qty}}" class="form-control"></td>
                                                <td class="text-center col-xs-1"><input type="text" name="limit[]" value="{{$pkg->limit_quantity}}" class="form-control"></td>
