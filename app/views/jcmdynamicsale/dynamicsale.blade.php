...
<div id="page-wrapper">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Jocom Dynamic Panel Management
              <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}jcmdynamicsale"><i class="fa fa-refresh"></i></a>
              </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url' => 'jcmdynamicsale/store' , 'class' => 'form-horizontal form-submit', 'files' => true , 'enctype' => "multipart/form-data")) }}
    ...
    <div class="panel panel-default">
      @if (Session::has('message'))
        ...
        <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Create Jocom Dynamic Panel </h2>
        </div>
        <div class="panel-body">
            <div class="col-lg-12">
                ...
                {{ Form::label('main_title', 'Main Title', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-6">
                    <input type="text" id="main_title" name="main_title" class="form-control" required = 'required'>
                </div> 
                </div>
                <div class='form-group'>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cell-small col-sm-1 text-center">Qty Sold</th>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Jocom Dynamic Panel Listing </h2>
        </div>
        <div class="panel-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="table_id" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" title="" data-toggle="tooltip" href="/jcmdynamicsale/edit/<?php echo $value->id; ?>"><i class="fa fa-pencil"></i></a>
                              
                              <a id="deleteBan" class="btn btn-danger" title="" data-toggle="tooltip" data-value="<?php echo $value->id; ?>" href="/jcmdynamicsale/delete/<?php echo $value->id; ?>"><i class="fa fa-times"></i></a>
                            </td>
                            </tr>
                       <?php } ?>
