        ...
        @endif
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        {{ Form::open(array('url'=>'coupon/addstaticcoupon', 'class' => 'form-horizontal')) }}
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" id="coupon" name="coupon_code" class="form-control" placeholder="" readonly>
                            ...
                            {{ Form::label('amount', "Amount ($currency)", array('class'=> 'col-lg-2 control-label')) }}
                                 <div class="col-lg-2">
                                    ...
                                    <input type="text" class="form-control" name="amount" id="amount" readonly required="required">
                                    <p class="help-block" for="inputError">{{$errors->first('amount')}}</p>
                                </div>
                                <div class="form-group @if ($errors->has('amount_type')) has-error @endif">
                                <div class="col-lg-2">
                                    <input type="text" class="form-control" name="amount_type" id="amount_type" readonly>
                                </div>
                            </div>
                            ...
                            {{ Form::label('Description', 'Description(T&C)', array('class'=> 'col-lg-2 control-label')) }}
                             ...
                             <div class="form-group @if ($errors->has('valid_from')) has-error @endif">
                                {{ Form::label('valid_from', 'Start Date', array('class'=> 'col-lg-2 control-label')) }}
                                 <div class="col-lg-3">
                                    {{Form::text('valid_from',null, array('id'=>'datepicker', 'placeholder' => 'yyyy-mm-dd', 'class'=>'form-control','required'=>'required'))}}
                                </div>
                            </div>
                            ...
                            <div class="form-group  @if ($errors->has('valid_to')) has-error @endif">
                                {{ Form::label('valid_to', 'End Date', array('class'=> 'col-lg-2 control-label')) }}
                                 <div class="col-lg-3">
                                    {{Form::text('valid_to',null, array('id'=>'datepicker2', 'placeholder' => 'yyyy-mm-dd', 'class'=>'form-control','required'=>'required'))}}
                                </div>
                            </div>
