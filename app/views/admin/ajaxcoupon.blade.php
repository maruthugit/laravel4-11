...
<body>
    ...
    <div class="wrapper">
        <div id="page-wrapper" style="margin: 0">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Coupon Management - Add Coupon</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-coupon">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-sm-3">Amount Type</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#dataTables-coupon').dataTable({
                "processing" : true,
                "serverSide" : true,
                "ajax" : "{{ URL::to('coupon/couponsajax') }}",
                "order" : [[0,'asc']],
                "lengthMenu" : [ 10 ],
                "bLengthChange" : false,
                "columnDefs" : [{
            ...
            $(document).on("click", "#selectCoup", function() {
                ...
                parent.$('input#coupon').val(localStorage.data1);
                parent.$('input#coupon_id').val(localStorage.data0);
                parent.$('input#amount').val(localStorage.data3);
                parent.$('input#amount_type').val(localStorage.data4);
