...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header"><i class="fa fa-file-o"></i>Manager</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            {{ Form::open(array('url'=>'/manager/update/' . $manager->id, 'class' => 'form-horizontal')) }}
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-pencil"></i>Manager Details</h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="form-group required {{ $errors->first('name', 'has-error') }}">
                            ...
                            <div class="col-lg-4">
                            {{ Form::text('name', $manager->name, ['placeholder' => 'Manager Name', 'class' => 'form-control']) }}
                        ...
                        <div class="form-group required {{ $errors->first('status', 'has-error') }}">
                            ...
                            <div class="col-sm-3">
                                <select class='form-control' name='status' id='status'>
                                    ...
                                    <option value='{{ $key }}' <?php if ($key == $manager->status) echo 'selected'?>>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
