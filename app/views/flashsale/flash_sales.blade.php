...
<div id="page-wrapper">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Flash Sale Management
              <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}flashsale"><i class="fa fa-refresh"></i></a>
              </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url' => 'flashsale/store' , 'class' => 'form-horizontal form-submit', 'files' => true)) }}
    ...
    <div class="panel panel-default">
      @if (Session::has('message'))
        ...
        <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Create Flash Sale </h2>
        </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <div class="input-group-btn">
                                        <span class="pull-left"><button id="addProdBtn" name="addProdBtn" class="btn btn-primary addProdBtn" data-toggle="tooltip" href="/flashsale/ajaxproduct"><i class="fa fa-plus"></i> Add Product</span>
                                    </div>
                                </div>
                                <br />
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cell-small col-sm-1 text-center">Per User Max Purchase Qty</th>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Flash Sale Listing </h2>
        </div>
        <div class="panel-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="table_id" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" title="" data-toggle="tooltip" href="/flashsale/edit/<?php echo $value->id; ?>"><i class="fa fa-pencil"></i></a>
                              
                              <a id="deleteBan" class="btn btn-danger" title="" data-toggle="tooltip" data-value="<?php echo $value->id; ?>" href="/flashsale/delete/<?php echo $value->id; ?>"><i class="fa fa-times"></i></a>
                            </td>
                            </tr>
                       <?php } ?>
