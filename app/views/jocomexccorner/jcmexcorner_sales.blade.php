...
<div id="page-wrapper">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Jocom Exclusive Corner Management
              <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}jocomexccorner"><i class="fa fa-refresh"></i></a>
              </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url' => 'jocomexccorner/store' , 'class' => 'form-horizontal form-submit', 'files' => true)) }}
    ...
    <div class="panel panel-default">
      @if (Session::has('message'))
        ...
        <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Create Jocom Exclusive Corner </h2>
        </div>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cell-small col-sm-1 text-center">Quantity Limit</th>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Jocom Exclusive Corner Listing </h2>
        </div>
        <div class="panel-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="table_id" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary" title="" data-toggle="tooltip" href="/jocomexccorner/edit/<?php echo $value->id; ?>"><i class="fa fa-pencil"></i></a>
                              
                              <a id="deleteBan" class="btn btn-danger" title="" data-toggle="tooltip" data-value="<?php echo $value->id; ?>" href="/jocomexccorner/delete/<?php echo $value->id; ?>"><i class="fa fa-times"></i></a>
                            </td>
                            </tr>
                       <?php } ?>
