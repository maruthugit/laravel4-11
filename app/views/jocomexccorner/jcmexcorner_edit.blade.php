...
@section('title') Jocom Exclusive Corner Management @stop
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Jocom Exclusive Corner Management
            <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}jocomexccorner/edit/<?php echo $flash->id; ?>"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-default" data-toggle="tooltip" href="{{asset('/')}}jocomexccorner"><i class="fa fa-reply"></i></a>
            </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url'=>'jocomexccorner/update/'.$flash->id , 'class' => 'form-horizontal form-submit', 'files' => true)) }}
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                ...
                {{ Form::label('main_title', 'Main Title', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-6">
                    {{ Form::text('main_title', $flash->main_title, array('class' => 'form-control') ) }}
                    </div>
                </div>  
                <div class='form-group'>
                ...
                <label for="banner_filename" class="col-lg-4 control-label">Banner Image (Resolution 640X300)</label>
                    <div class="input-group">
                                            ...
                                            <img id="previewIMG" style="width: 100%;margin-top: 10px;" src="{{asset('exclusivecorners/banner')}}/{{$flash->banner_filename}}">
                                            @endif
                                        </div>
                                        </div>
                                        </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <span class="pull-left"><button id="addProdBtn" name="addProdBtn" class="btn btn-primary addProdBtn" data-toggle="tooltip" href="/jocomexccorner/ajaxproduct"><i class="fa fa-plus"></i> Add Product</span>
                                        </div>
                                    </div>
                                    <br />
