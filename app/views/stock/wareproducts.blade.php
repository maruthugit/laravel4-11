...
<body>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-products">
                                    <thead>
                                        <tr>
                                            ...
                                            <!--<th class="col-sm-2">Seller Name</th>-->
    ...
    <script type="text/javascript">
            ...
            $('#dataTables-products').dataTable({
                "processing" : true,
                "serverSide" : true,
                "ajax" : "{{ URL::to('stock/anywproducts') }}",
                "order" : [[ 0, 'desc' ]],
                "lengthMenu" : [ 10 ],
                "bLengthChange" : false,
                "columnDefs" : [{
...
//                    { "data" : "3" },
            ...
            $(document).on("click", "#selectItem", function() {
                ...
                var rowTd = $('<tr id="'+lid+'" class="product">\
                                 ...
                                 <td> <b> {{ $name }}</b> <br>'+ localStorage.data1 +'<br><i class="fa fa-tag"></i> {{$sku}} '+ localStorage.data2 +'</td>\
                                     <td class="hidden-xs hidden-sm col-xs-1"><input type="text" class="form-control col-xs-2" name="qty[]" value="" required></td>\
