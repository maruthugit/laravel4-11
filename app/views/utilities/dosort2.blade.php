                ...
                <div class="panel-body">
                    <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs"> 
                        ...
                        <ul class="nav nav-tabs" id="myTabs" role="tablist"> 
                            ...
                            <li role="presentation" class="">
                                <a href="#attention" role="tab" id="combine-tab" data-toggle="tab" aria-controls="combine" aria-expanded="false" style="color:#e04747;"> Attention DO (Sorted Not Approve)</a>
                            </li> 
                            <li role="presentation" class="">
                                <a href="#attentionnosort" role="tab" id="combine-tab" data-toggle="tab" aria-controls="combine" aria-expanded="false" style="color:#e04747;"> Attention DO (No Sort)</a>
                            </li> 
                        </ul> 
                        <div class="tab-content" id="myTabContent" > 
                            <div class="tab-pane fade in" role="tabpanel" id="attention" aria-labelledby="home-tab" style="margin-top: 20px;padding: 15px;"> 
                                <table class="table table-striped"  id="attention-list"> 
                                   <thead> 
                                       <tr> 
                                           <th>Tran. Date</th> 
                                           <th>Tran. ID</th> 
                            ...
                            <div class="tab-pane fade in" role="tabpanel" id="attentionnosort" aria-labelledby="home-tab" style="margin-top: 20px;padding: 15px;"> 
                                <table class="table table-striped"  id="attention-nolist"> 
                                   <thead> 
                                       <tr> 
                                           <th>Tran. Date</th> 
                                           <th>Tran. ID</th> 
...
//            { data: 'filename', name: 'filename' },
    ...
    function getAttentionList(){
        ...
        $('#attention-list').dataTable({
        "autoWidth" : false,
        "processing": true,
        "ordering": false,
        "serverSide": true,
        "ajax": "{{ URL::to('transaction/attentionlist') }}",
        "order" : [[0,'desc']],
        "columnDefs" : [{
            "targets" : "_all",
            "defaultContent" : ""
        ...
        "columns" : [
            ...
            { data: 'LogLogisticDate', name: 'LogLogisticDate' },
            { data: 'TotalDaysDelay' , name: 'TotalDaysDelay'  },
            { data: 'DeliveryState', name: 'DeliveryState' },
            { data: 'SortBatchNo', name: 'SortBatchNo' },
            { data: 'SortBY', name: 'SortBY' },
            { data: 'SORT_STATUS', name: 'SORT_STATUS' },
            { data: 'APPROVAL', name: 'APPROVAL' },
            ]
        }); 
    }
    
    function getAttentionnosortList(){
        
        $('#attention-nolist').dataTable({
        "autoWidth" : false,
        "pageLength": 200,
        "processing": true,
        "ordering": false,
        "serverSide": true,
        "ajax": "{{ URL::to('transaction/attentionnosortlist') }}",
        "order" : [[0,'desc']],
        "columnDefs" : [{
            "targets" : "_all",
            "defaultContent" : ""
...
//                                           <th>Remarks</th> 
                    ...
                    if((data.purchaseList).length > 0){
                        $.each( data.purchaseList, function( key, value ) {
                            ...
                            var loopCounter = 0;
                            purchaseListing = purchaseListing + '<tr style="background-color:#ddd;'+seperator+'"><td><input class="add-remove" type="checkbox" value="'+value.product_id+'"></td><td>'+value.product_name+'</td><td>'+value.product_sku+'</td><td>'+value.product_label+'</td><td>'+value.company_name+'</td><td  style="text-align:center;">'+value.total_order+'</td><td  style="text-align:center;">'+value.req_qty+'</td><td style="text-align:center;">'+totalBaseRequired+'</td><td style="text-align:center;">'+value.unit_price+'</td></tr>';//value.unit_price
                            if((value.base_product).length > 0){
