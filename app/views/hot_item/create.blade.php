...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-comments-o"></i> Hot Items Management 
    ...
    <!-- /.row -->
    <div class="row">
        {{ Form::open(array('url' => 'hot_item/store', 'class' => 'form-horizontal', 'files'=> true)) }}
                ...
                <div class="panel-body">
                    <div class="col-lg-12 table-responsive">
                        <table class="table table-hover" style="text-align:center;">
                            ...
                            <tr>
                                @if($code == "en")
                                <td>{{ Form::label('hot_item', '* '.$name, array('class' => 'col-lg-3 control-label')) }}</td>
                                @else
                                <td>{{ Form::label('hot_item', $name, array('class' => 'col-lg-3 control-label')) }}</td>
                                @endif
                                <td>
