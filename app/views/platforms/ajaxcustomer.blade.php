...
<body>
    ...
    <div class="wrapper">
        <div id="page-wrapper" style="margin: 0">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Platform Management - Add Platform User</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#dataTables-users').dataTable({
                "processing" : true,
                "serverSide" : true,
                "ajax" : "{{ URL::to('transaction/customersajax') }}",
                "order" : [[0,'asc']],
                "lengthMenu" : [ 10 ],
                "bLengthChange" : false,
                "columnDefs" : [{
            ...
            $(document).on("click", "#selectCust", function() {
                ...
                parent.$('input#platform_username').val(localStorage.data1);
                parent.$('input#platform_user_id').val(localStorage.data0);
