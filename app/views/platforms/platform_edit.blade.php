...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Platform/Store
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    @if(isset($list))
{{ Form::open(array('url'=>'platforms/platformupdate/'.$list->id , 'class' => 'form-horizontal form-submit')) }}
        ...
        <div class="panel-body">
            <div class="col-lg-12">
             ...
             <div class="form-group @if ($errors->has('platform_username')) has-error @endif">
                            ...
                            <input type="hidden" id="platform_user_id" name="platform_user_id" value="{{$list->platform_user_id}}">
                            <div class="col-lg-4">
                                <div class="input-group">
                                <input type="text" id="platform_username" name="platform_username" class="form-control" placeholder="" readonly required ='required' value="{{$list->platform_username}}">
...
@endif
@if(isset($store))
{{ Form::open(array('url' => 'platforms/updatestores/'.$store->id , 'class' => 'form-horizontal form-submit')) }}

    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-pencil"></i> Edit Store</h2>
        </div>
        <div class="panel-body">
            <div class="col-lg-12">
                <div class='form-group'>
                {{ Form::label('store_title', 'Store Name *', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-4">
                    <input type="text" id="store_name" name="store_name" class="form-control" required ='required' value="{{$store->store_name}}">
                </div> 
                </div>
                <div class='form-group'>
                {{ Form::label('store_id', 'External Store ID *', array('class' => 'col-lg-2 control-label')) }}
                    <div class="col-lg-4">
                    <input type="text" id="store_id" name="store_id" class="form-control" required ='required' value="{{$store->external_store_id}}">
                </div> 
                </div>
             <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select name='platform_id' class="form-control" required>
                                    ...
                                    <option value='{{$value->id}}' <?php if($store->platform_id==$value->id){ echo 'selected="selected"';} ?>>{{$value->platform_name}}</option>
                                    @endforeach
                                    @endif
                                    </select>
                                </div><!-- /input-group -->
                 ...
                 <div class="form-group @if ($errors->has('status')) has-error @endif">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                              <select name='status' class="form-control" required><option value='0' <?php if($store->status==0){ echo 'selected="selected"';} ?>>Inactive</option><option value='1' <?php if($store->status==1){ echo 'selected="selected"';} ?>>Active</option></select>
                                </div><!-- /input-group -->
                            </div><!-- /.col-lg-6 -->
                </div> 
                <hr/>
