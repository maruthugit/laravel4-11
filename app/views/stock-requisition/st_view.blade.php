...
?>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 40%;">
                <font size="3"><strong>STOCK REQUISITION FORM</strong></font>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 40%;" class="address_container">
                ...
                Stock Requisition No: {{$st['st_no']}}<br />
                Platform: {{$st['platform']}}<br />
            </td>
        </tr>
    ...
    <table border="1" cellpadding="5" style="width: 100%;" class="address_container">
        <thead>
            <tr>
                ...
                <th style="width: 15%;" class="address_container">Expiry Date</th>
        ...
        ?>
            <tr class="item-row<?php echo ($loopCount > 1) ? ' no-top' : '';?>">
                ...
                <td align="center" class="address_container" style="width: 7%;">{{$product->expiry_date}}</td>
    ...
    <br /><br /><br />
    <table style="width: 93%;" class="address_container">
        <tr>
            <td style="width: 20%;">
                <i>Requested By</i>
                <br><br><br><br>
            ...
            <td style="width: 20%;"></td>
            <td style="width: 25%;">Checked By (Warehouse)</td>
...
<a href="<?php echo '/stock-requisition/download/'.$encrypted?>"><button id="download">Download</button></a>
