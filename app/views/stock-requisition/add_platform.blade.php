        ...
        <div class="col-lg-12">
            <h1 class="page-header">Stock Requisition Platform
              <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}stock-requisition/createplatform"><i class="fa fa-refresh"></i></a>
              </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
...
@if (Session::has('message'))
            ...
            @endif
    {{ Form::open(array('url' => 'stock-requisition/storeplatform' , 'class' => 'form-horizontal form-submit')) }}
