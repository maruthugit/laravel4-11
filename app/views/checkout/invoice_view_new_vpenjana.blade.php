        ...
        <table class="page_footer">
            <tr>
                <td style="width: 100%; text-align: right">
                    Page [1]/[1] ({{$display_details['invoice_no']}})
                </td>
            </tr>
        </table>
    </page_footer>
            ...
            <td>
                ...
                ** GST {{$display_trans->gst_rate}}% -->
                <?php
                    ...
                    {
                        ?>
                       <!--  <br /> Exchange Rate (<?php //echo $invoice_bussines_currency." ".$invoice_bussines_currency_rate ." = ". $standard_currency." ".$standard_currency_rate; ?>
