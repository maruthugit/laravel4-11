...
<?php } ?>
    ...
    <table border="1" scellpadding="1"  cellspacing="0" style="width: 100%; border:solid 1px #000000;" >
        ...
        ?>  
            <tr>
                <td class="address_container"  style="width: 22%;">{{$product->sku}}</td>
                <td class="address_container"  style="width: 35%;">
                    {{$product->description}}
                </td>
                <td class="address_container" style="width: 30%;">{{$product->price_label}}</td>
                <td class="address_container" style="width: 10%;" align="center"><?php if( is_numeric( $product->unit ) && floor( $product->unit ) != $product->unit)
