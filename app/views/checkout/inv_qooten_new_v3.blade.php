    ...
    <table style="width: 100%;border-top: 1px solid #000;border-bottom: 1px solid #000;" class="address_container">
        <thead>
            ...
            <tr>
                ...
                <th style="width: 12%;" valign="top" class="address_container">Unit Price({{Config::get("constants.CURRENCY")}})</th>
                <th style="width: 9%;" valign="top" class="address_container">Promo Price({{Config::get("constants.CURRENCY")}})</th>
                <th style="width: 12%;" valign="top" class="address_container">Total Value ({{Config::get("constants.CURRENCY")}})</th>
                <!--<th style="width: 12%;" valign="top" class="address_container">Total Excl. GST<br />({{Config::get("constants.CURRENCY")}})</th>-->
                <!--<th style="width: 9%;" valign="top" class="address_container">GST @ {{$display_trans->gst_rate}}%<br />({{Config::get("constants.CURRENCY")}})</th>-->
                <!--<th style="width: 10%;" valign="top" class="address_container">Total Incl. GST<br />({{Config::get("constants.CURRENCY")}})</th>-->
            </tr>
            <tr>
        ...
        ?>
            <tr>
                ...
                <td style="width: 24%;" class="address_container">
                    ...
                    *<?php if($product->gst_amount > 0) echo '*'; ?>{{$product->sku}}
                </td>
      ...
      <!--   <tfoot> -->
            ...
            if ($toCustomer == 1)
            {
                $gst_total = $subtotal_gst +$gst_delivery;
            ?>
            <tr>
            ...
            <tr>
                <td colspan="4" style="border-top: 0px; border-bottom: 0px;" class="address_container">
                    **Delivery Charges
                </td>
            ...
            <tr>
                <td colspan="4" style="border-top: 0px;" class="address_container">
                    **Processing Fee
                </td>
           ...
           // $subtotal_excl_gst += $delivery_charges + $process_fees-$display_coupon['coupon_amount'];
            ...
            <tr>
                <td colspan="4" style="border-top: 0px;" class="address_container"><?php if ($display_points->count() || $display_coupon>0){ echo "Total";}else{ echo "Grand Total"; }?></td>
