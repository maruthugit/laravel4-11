            ...
            @if ($grand_amt > 0)
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <input type="radio" name="payopt" value="mpay" id="input-mpay" checked>
                        ...
                        @if (Session::get('devicetype') == 'android')
                            ...
                            <?php if($trans_row->buyer_username == 'StevenPongidin') {?>   
                            <div class="col-md-4">
                                    ...
                                    <label class="label-payment-img" for="input-molpay">
                                        ...
                                        <br><small>(FPX, Credit Card, CIMB Clicks, Maybank2U)</small>
                                    </label>
                                </div>
                            <?php }else{ ?>
                                <div class="col-md-4">
