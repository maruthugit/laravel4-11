    ...
    <table style="width: 100%;border-top: 1px solid #000;border-bottom: 1px solid #000;" class="address_container">
        <thead>
            ...
            <tr>
                ...
                <th style="width: 12%;" valign="top" class="address_container">Unit Price<br />({{Config::get("constants.CURRENCY")}})</th>
                <th style="width: 12%;" valign="top" class="address_container">Gross Value<br />({{Config::get("constants.CURRENCY")}})</th>
                <th style="width: 9%;" valign="top" class="address_container">Disc.<br />({{Config::get("constants.CURRENCY")}})</th>
        ...
        ?>
            <tr>
                ...
                <td style="width: 24%;" class="address_container">
                    <?php if($product->product_name != ''){?> {{$product->product_name}} <?php } elseif($product->description != '') { ?>>{{$product->description}} <?php } else { ?>{{$product->name}}<?php } ?><br /><br />
                ...
                <td style="width: 10%;" align="center" class="address_container">{{number_format($product->price, 2, ".", "")}}</td>
                <td style="width: 10%;" align="center" class="address_container">{{number_format($product->total, 2, ".", ",")}}</td>
                <td style="width: 7%;" align="center" class="address_container">
                <?php if(number_format($product_disc, 2, ".", "") <> '0.00'){  ?>
                    {{number_format($product_disc, 2, ".", "")}}
                <?php } ?>
                </td>
