...
switch (Session::get('lang')) {
    case 'CN':
        $code['001'] = '已经收到您的付款.<br />JOCOM感谢您的光顾.';
        $code['002'] = '很遗憾您的订单已被取消.<br />JOCOM感谢您的到访.';
        $code['003'] = '请到交易记录检视您的交易状态.';
        $code['004'] = '您的付款状态为"Pending".<br />JOCOM感谢您的光顾.';
        $code['005'] = '很遗憾您的付款已被取消.<br />JOCOM感谢您的到访.';
        ...
        $code['115'] = 'Oops, you are not allow to purchase '.$kkwprod.' more than 2 quantity.';
        break;
    case 'MY':
        $code['001'] = 'Transaksi anda telah berjaya.<br />Terima kasih kerana membeli-belah kat JOCOM.';
        $code['002'] = 'Dukacitanya pesanan anda telah dibatal.<br />Terima kasih kerana mengunjungi JOCOM';
        $code['003'] = 'Periksa status pesanan anda dalam Senarai Transaksi.';
        $code['004'] = 'Status bayaran anda adalah "Pending".<br />Terima kasih kerana beli-belah kat JOCOM.';
        $code['005'] = 'Dukacitany bayaran anda gagal.<br />Terima kasih kerana mengunjungi JOCOM';
                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="bcardRewardForm">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="transactionId" value="96260">
                                            <input type="text" class="form-control" name="bcard" placeholder="BCard No." value="6298435900540689">
