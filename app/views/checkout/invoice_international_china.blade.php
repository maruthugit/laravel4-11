    ...
    <body>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="text-align:left;font-size: 12px;">GST Reg No 消费税注册编号 : 001077620736</td>
            </tr>
            <tr>
                <td style="text-align:right;font-size: 12px;width: 65%;"></td>
        ...
        <table style="width:100%; padding: 0px;margin-top:30px;" border="1" cellpadding="0" cellspacing="0">
            <tr style="font-size:12px;text-align: center;">
                <td style="padding: 10px;    width: 25%;">DESCRIPTION OF GOODS <br>托寄物名称 </td>
...
<!--            <tr style="font-size:12px;text-align: left;">
            ...
            <tr style="font-size:12px;text-align: left;">
                ...
                <td style="padding: 4px 4px 4px 10px; " ><?php echo $BusinessCurrency; ?> <?php echo number_format($TotalBusinessCurrency, 5, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format($TotalAlternativeCurrency, 2, '.', ''); ?>)</span></td>
            </tr>
            <tr style="font-size:12px;text-align: left;">
                <td style="padding: 4px 4px 4px 10px;  text-align: right;" colspan="5">Delivery Charges 总销售量</td>
                <td style="padding: 4px 4px 4px 10px; " ><?php echo $BusinessCurrency; ?> <?php echo number_format($TotalBusinessCurrencyDeliveryCharges, 5, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format($TotalAlternativeCurrencyDeliveryCharges, 2, '.', ''); ?>)</span></td>
            </tr>
            <tr style="font-size:12px;text-align: left;">
                <td style="padding: 4px 4px 4px 10px;  text-align: right;" colspan="5">GST 消费税  @ 0%</td>
                 <td style="padding: 4px 4px 4px 10px; " ><?php echo $BusinessCurrency; ?> <?php echo number_format(0.00, 5, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format(0.00, 2, '.', ''); ?>)</span></td>
            </tr>
            <tr style="font-size:12px;text-align: left;">
                <td style="padding: 4px 4px 4px 10px; text-align: right;" colspan="5">Total Amount 总金额</td>
                <td style="padding: 4px 4px 4px 10px; " ><?php echo $BusinessCurrency; ?> <?php echo number_format($TotalBusinessCurrency + $TotalBusinessCurrencyDeliveryCharges, 5, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format($TotalAlternativeCurrency + $TotalAlternativeCurrencyDeliveryCharges, 2, '.', ''); ?>)</span></td>
           </tr>
            <tr style="font-size:12px;text-align: left;">
