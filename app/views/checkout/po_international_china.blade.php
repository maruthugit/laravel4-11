...
<style type="text/css">
    ...
    <body>
        ...
        <table style="width:100%; "> 
            <tr>
                <td style="text-align: center;font-weight: bold;font-size: 25px;">PURCHASE ORDER</td>
            </tr>
            <tr>
                <td style="text-align: center;font-weight: 100;font-size: 25px;">采购订单</td>
            </tr>
            <tr>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="text-align:left;font-size: 12px;">PO Date 订单日期 : <?php echo $invoiceInfo['invoice_date'];?></td>
            </tr>
            <tr>
                <td style="text-align:right;font-size: 12px;width: 65%;"></td>
                <td style="text-align:left;font-size: 12px;">PO Number 订单号 : <?php echo $trans->customer_po;?></td>
            </tr>
            <tr>
                <td style="text-align:right;font-size: 12px;width: 65%;"></td>
        ...
        <table style="width:100%; padding: 0px;border-top: double;margin-top: 10px;">
            <tr style="">
                ...
                <td style="width: 50%; vertical-align: top;" >
                    <table>
                        <tr>
                            <td colspan="2">TO : <span style="font-size:10px;"></span></td>
                        </tr>
        ...
        <table style="width:100%; padding: 0px;border-top: double;margin-top: 10px;">
                <tr>
                    <td colspan="2">Delivery Address : <span style="font-size:10px;"></span></td>
                </tr>
                <tr>
                    <td style="text-align:left;font-size: 12px;">Contact Name : <br><span style="font-size:9px;">(联络人姓名)</span></td>
                    <td style="text-align:left;font-size: 12px;vertical-align: text-top;"><?php echo $invoiceTo['invoice_to_recipient'];?></td>
        ...
        <table style="width:100%; padding: 0px;margin-top:30px;" border="1" cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($productItems as $key => $value) { ?>
                <tr style="font-size:12px;text-align: left;">
                    ...
                    <td style="padding: 10px;"><?php echo $BusinessCurrency; ?> <?php echo number_format($value['product_unit_price'], 2, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format($value['product_alternative_unit_price'], 2, '.', ''); ?>)</span></td>
                    <td style="padding: 10px;"><?php echo $BusinessCurrency; ?> <?php echo number_format($value['product_total_price'], 2, '.', ''); ?><br><span style="font-size:9px;">(<?php echo $AlternativeCurrency; ?> <?php echo number_format($value['product_alternative_total_price'], 2, '.', ''); ?>)</span></td>
                </tr>
            <?php } ?>
<!--            <tr style="font-size:12px;text-align: left;">
            ...
            <tr style="font-size:12px;text-align: left;">
                <td style="padding: 6px;" colspan="5">Term of Trade 贸易条件 (USD) <br> Exchange Rate (兑换率) : 1 <?php echo $BusinessCurrency; ?> = <?php echo $trans->base_currency_rate; ?> <?php echo $AlternativeCurrency; ?>
            </tr>
        ...
        <table style="width:100%; padding: 0px;margin-top:30px;font-size:12px" border="0" cellpadding="0" cellspacing="0">
            <tr><td>REMARKS:</td></tr>
            <tr><td>备注:</td></tr>
            <tr><td style="text-align: left;">This is a computer generated document. No signature required.  </td></tr>
            <tr><td style="text-align: left;">这是一份由系统设定的文件。免签名。</td></tr>
        </table>
    </body>
</html>