      ...
      <!--   <tfoot> -->
           ...
           // $subtotal_excl_gst += $delivery_charges + $process_fees-$display_coupon['coupon_amount'];
            ...
            @foreach ($display_points as $point)
                ...
                <tr>
                    <td colspan="4" style="border-top: 0px;" class="address_container">{{ $point->type }} ({{ $point->point }} points)</td>
                    <td align="center" class="address_container">
...
<!--            @if ($display_points->count())
            ...
            ?>
                <tr>
                <td colspan="5" style="width: 100%;border-bottom: 0.5px " class="address_container"></td>
               </tr>
                <tr>
                    <td colspan="4" style="border-top: 0px;" class="address_container">Grand Total</td>
                    <td align="center" class="address_container">
                        <?php
