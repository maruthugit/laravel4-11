...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <span class="pull-right">
                <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}jcmcombodeals/edit/<?php echo $flash->id; ?>"><i class="fa fa-refresh"></i></a>
                <a class="btn btn-default" data-toggle="tooltip" href="{{asset('/')}}jcmcombodeals"><i class="fa fa-reply"></i></a>
            </span>
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    ...
    {{ Form::open(array('url'=>'jcmcombodeals/update/'.$flash->id , 'class' => 'form-horizontal form-submit', 'files' => true)) }}
            ...
            <div class="col-lg-12">
                ...
                <label for="banner_filename" class="col-lg-4 control-label">Banner Image (Resolution 640X300)</label>
                    <div class="input-group">
                                            ...
                                            <img id="previewIMG" style="width: 100%;margin-top: 10px;" src="{{asset('combodeals/banner')}}/{{$flash->banner_filename}}">
                                            @endif
                                        </div>
                                        </div>
                                        </div>
