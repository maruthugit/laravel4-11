...
<div id="page-wrapper">
	...
	{{ Form::open(array('url' => 'ecombanner/update/'.$id , 'class' => 'form-horizontal', 'files' => true)) }}
		...
		<div class="panel-body">
			<div class="col-lg-12 ">
				...
				{{ Form::label('qrcode', 'QR Code', array('class' => 'col-lg-1 control-label')) }}
					<div class="col-lg-6">
					{{ Form::text('qrcode', $qrcode, array('class' => 'form-control') ) }}
		...
		<div class="panel-body">
			<div class="col-lg-12 table-responsive">
				...
				<div class="fileinput fileinput-new" data-provides="fileinput">
					{{ HTML::image($image, null ,array( 'id' => 'ss70' )) }}
