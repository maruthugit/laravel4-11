            ...
            <li {{(Request::is('product/*', 'campaigns/*') || Request::is('product') ? 'class="active"' : '')}} {{(Request::is('inventory*') ? 'class="active"' : '')}} >
                ...
                <ul class="nav nav-second-level">                   
                    ...
                    <!--</li>-->
                        ...
                        @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 2, array('product/bulkeditstatus','product/bulkeditquantity', 'product/bulkeditactualstock')))
            ...
            <li {{(Request::is('purchase-order*') ? 'class="active"' : '')}}>
                ...
                <ul class="nav nav-second-level">
                    ...
                    @if ( Permission::CheckAccessLevel(Session::get('role_id'), 4, 5, 'AND') || Permission::CheckAccessLevel(Session::get('role_id'), 29, 1, 'OR') ) 
                        ...
                        @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 29, array('payment-terms','payment-terms/create' )))
                        ...
                        @endif
                        @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 29, array('manager','manager/create' )))
                        ...
                        @endif
                        @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 29, array('warehouse-location','warehouse-location/create' )))
                        ...
                        @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 29, array('einvoice','einvoice/pbx' )))
                ...
                <li {{(Request::is('gdf*') || Request::is('stock-transfer*') ? 'class="active"' : '')}}>
                    ...
                    <ul class="nav nav-second-level">
                        @if ( Permission::CheckAccessLevel(Session::get('role_id'), 4, 5, 'AND') || Permission::CheckAccessLevel(Session::get('role_id'), 31, 1, 'OR'))
                            @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 31, array('gdf','gdf/create','gdf/report')))        
                            ...
                            @endif
                            @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 31, array('stock-transfer','stock-transfer/create','')))        
                ...
                <li {{(Request::is('warehouse*', 'warehouse*') ? 'class="active"' : '')}}>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php if (Session::get('username') != 'tracyyap')  {  ?>
                            @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 24, array('stock','stock/create')))
                            ...
                            @endif
                            @if (Permission::CheckSubModAccess(Session::get('role_id'), Session::get('user_id'), 24, array('pallet','supplier')))
