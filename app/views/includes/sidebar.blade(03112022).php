...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            @endif
            <?php if (in_array(Session::get('username'), array('joshua', 'agnes', 'maruthu','quenny','william','kean','cocoyeo','sookying','chloe','wengkai','fooyau','sclim','choong','gladys','marcochin','jokonn','rebecca','yeehao','kokhou','kent','belleloh','pysoon'), true ) ) {  ?>
                @if ( Permission::CheckAccessLevel(Session::get('role_id'), 17, 1, 'OR'))
                    <li {{(Request::is('report*') || Request::is('mailchimp-report*') ? 'class="active"' : '')}}>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                {{ HTML::link('report/edagangweek', 'EDAGANG Report', array('class' => Request::is('report/edagangweek') ? 'active' : '')) }}
                            </li>
                            <?php  } ?>
