        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> Queue List</h3>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTablePushListing">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-sm-1">Send Date</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to delete this notification from queue?
            </div>
            <div class="modal-footer">
                {{ Form::open(['url' => 'push/queue/delete']) }}
...
$('#dataTablePushListing').dataTable({
    ...
    'processing': true,
    'serverSide': true,
    'ajax': '{{ URL::to('push/dataqueue') }}',
    'order': [[4, 'asc']], // Order by date, ascending
    'columnDefs': [{
        'targets': '_all',
        'defaultContent': ''
    }],
