...
<body>
    ...
    <div class="wrapper">
        <div id="page-wrapper" style="margin: 0">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Purchase Order Management - Select PO</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                @endif
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-list"></i> PO Listing</h3>                    
                        </div>
                        <!-- /.panel-heading -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#dataTables-sellers').dataTable({
                "processing" : true,
                "serverSide" : true,
                "ajax" : "{{ URL::to('purchase-order/fetch-po') }}",
                "order" : [[0,'asc']],
                "lengthMenu" : [ 10 ],
                "bLengthChange" : false,
                "columnDefs" : [{
            ...
            $(document).on("click", "#selectPO", function() {
                ...
                parent.$('input#po_id').val(localStorage.data0);
                parent.$('input#po_no').val(localStorage.data1);
