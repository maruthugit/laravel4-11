...
@section('title', 'PO PracBix')
@section('content')

<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">PO PracBix
                <span class="pull-right">
                    <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}purchase-order/pbx"><i class="fa fa-refresh"></i></a>
                </span>
            </h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            {{ Form::open(array('url'=>'/purchase-order/pbx/generate-zip', 'class' => 'form-horizontal')) }}
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group required {{ $errors->first('po_date', 'has-error') }}">
                            {{ Form::label('po_date', 'PO Date', array('class' => 'col-lg-1 control-label')) }}
                            <div class="col-lg-3">
                                <div class="input-group" id="datetimepicker_from">
                                    <input id="po_date" class="form-control" tabindex="1" name="po_date" type="text" value="{{ $today }}">
...
<form id="complete_form" name="complete_form" action="/purchase-order/pbx/complete" method="post">
...
@section('script')
    ...
    $('#dataTables-pbx').dataTable({
        ...
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('purchase-order/pbx/list') }}",
        "order": [[2,'asc'], [0,'desc']],
        "columnDefs": [{
            "targets": "_all",
            "defaultContent": ""
