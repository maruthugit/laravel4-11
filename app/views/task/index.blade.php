...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
           <h1 class="page-header">Ticketing</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="panel panel-default form-panel" >
        ...
        <div class="panel-body" style="padding-top:0px;padding-bottom: 0px;">
            ...
            <div class="row" id="v-list">
                <div class="col-md-12  col-xs-12 animated list-panel" style="">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
                                <div class="col-md-12 main-sub-panel">
                                    <button class="btn btn-default btn-sm pull-right" id="filter1">Submit</button>
                                    <p>
                                        Status: 
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="0">Pending</label>
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="1">Resolve</label>
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="2">Cancel</label>
                                    </p>
                                    <p>
                                        Platform: 
                                        <?php $platform = array_combine(array_keys($ThirdPatryPlatform), array_keys($ThirdPatryPlatform)); ?>
                                        @foreach($platform as $plat_key => $plat)
                                            <label style="margin-bottom: 0px;"><input type="checkbox" name="platform" value="{{ $plat_key }}">{{ $plat }}</label>
                                        @endforeach
                                    </p>
                                    <label style="margin-bottom: 0px; font-weight: normal;">
                                        Vendor: 
                                        <select name="vendor" class="form-control" style="width: auto; display: inline-block; vertical-align: middle; font-weight: normal;">
                                        @foreach($ThirdPatryPlatform as $plat_key => $plat)
                                            <option disabled selected>Please Select Vendor</option>
                                            <optgroup label="{{ $plat_key }}">
                                            @if($plat)
                                            @foreach($plat as $vendor_key => $val)
                                                <option value="{{ $plat_key . '.' . $vendor_key }}">{{ $val['name'] }}</option>
                                            @endforeach
                                            @endif
                                            </optgroup>
                                        @endforeach
                                ...
                                <div class="col-md-12 main-sub-panel">
                                   <table class="table" id="inbox-list">
                                        <thead>
                                           <tr> 
                                                <th>Task ID</th>
                            ...
                            <div class="tab-pane fade" role="tabpanel" id="profile" aria-labelledby="profile-tab">
                                <div class="col-md-12 main-sub-panel">
                                    <button class="btn btn-default btn-sm pull-right" id="filter2">Submit</button>
                                    <p>
                                        Status: 
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="0">Pending</label>
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="1">Resolve</label>
                                ...
                                <div class="col-md-12 main-sub-panel">
                                    <table class="table" id="inbox-list2">
                                        <thead>
                                           <tr> 
                                                <th>Task ID</th>
                                                <th>Transaction ID</th>
                            ...
                            <div class="tab-pane fade" role="tabpanel" id="overview2" aria-labelledby="overview-tab">
                                <div class="col-md-12 main-sub-panel">
                                    <button class="btn btn-default btn-sm pull-right" id="filter3">Submit</button>
                                    <p>
                                        Status: 
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="0">Pending</label>
                                        <label style="margin-bottom: 0px;"><input type="checkbox" name="status" value="1">Resolve</label>
                                ...
                                <div class="col-md-12 main-sub-panel">
                                    <table class="table" id="inbox-list3">
                                        <thead>
                                            <tr> 
                                                <th>Task ID</th>
                                                <th>Transaction ID</th>
