...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Boost 11.11 Deals
...
@section('inputjs')
    ...
    //            { "data" : "0", "className" : "text-center" },
                ...
                { data: function ( row, type, val, meta ) {
                    return '<button style="text-align:center;"  class="btn btn-default triggerAdd" data-transaction-id="'+row[0]+'" type="button" title="Add to Boost">Add to Boost 11.11 <i class="fa fa-angle-double-right"></i> </button>';
                    }
                }
            ]
        });
    ...
    function removeCampaignProduct(product_campaign_id){
        ...
        $.ajax({
            method: "POST",
            url: "/boost11deals/removeproduct",
            dataType:'json',
            data: {
                'product_campaign_id':product_campaign_id
            },
...
//                        location.reload();
    ...
    $(document).on("click", ".upt-position", function(e) {
            ...
            if(ParentDOM.find('input').val() >= 0 ){
                ...
                $.ajax({
                    type: 'POST',
                    url: '/boost11deals/campaignupdate',
                    data: {
                        "product_campaign_id" : product_campaign_id,
