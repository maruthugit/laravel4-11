...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Live Streaming 
...
@section('inputjs')
    ...
    //            { "data" : "0", "className" : "text-center" },
                ...
                { data: function ( row, type, val, meta ) {
                    return '<button style="text-align:center;"  class="btn btn-default triggerAdd" data-transaction-id="'+row[0]+'" type="button" title="Add to Livestream">Add to Livestream <i class="fa fa-angle-double-right"></i> </button>';
                    }
                }
            ]
        });
