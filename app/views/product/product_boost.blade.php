...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Boost Exclusive Deals Corner
...
@section('inputjs')
    ...
    //            { "data" : "0", "className" : "text-center" },
                ...
                { data: function ( row, type, val, meta ) {
                    return '<button style="text-align:center;"  class="btn btn-default triggerAdd" data-transaction-id="'+row[0]+'" type="button" title="Add to Boost">Add to Boost Deals <i class="fa fa-angle-double-right"></i> </button>';
                    }
                }
            ]
        });
