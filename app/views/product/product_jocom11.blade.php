...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Jocom 11.11 Deals
...
@section('inputjs')
    ...
    function removeCampaignProduct(product_campaign_id){
        ...
        $.ajax({
            method: "POST",
            url: "/jocom11deals/removeproduct",
            dataType:'json',
            data: {
                'product_campaign_id':product_campaign_id
            },
...
//                        location.reload();
    ...
    $(document).on("click", ".upt-position", function(e) {
            ...
            if(ParentDOM.find('input').val() >= 0 ){
                ...
                $.ajax({
                    type: 'POST',
                    url: '/jocom11deals/campaignupdate',
                    data: {
                        "product_campaign_id" : product_campaign_id,
