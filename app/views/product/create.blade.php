...
<!--						<div class="form-group @if ($errors->has('seller_name')) has-error @endif">
						...
						<hr>-->
							...
							<div class="col-lg-3">
								<select class="form-control" id="region_country_id" name="region_country_id">
                                                                <?php foreach ($countries as $key => $value) { ?>
                                                                    <option value="<?php echo $value->id; ?>" <?php if($value->id ==458 ){ echo "selected";} ?>><?php echo $value->name;?></option>
                                                                <?php } ?>
                                                            </select>
							...
							<div class="col-lg-3">
							                            <?php
                                                        if (in_array(Session::get('username'), array("maruthu","quenny","william","joshua","agnes","winnie","asif"))) {
                                                        ?>
						...
						<div class="col-lg-3" style="font-weight: bold;margin-left: -40px;">
									<label class="radio-inline" style="font-weight: bold;font-weight: bold;"><input type="checkbox" name="is_jpoint" value="1"> TPoints </label>
				<br>
								<label class="radio-inline" style="font-weight: bold;"> <input type="checkbox" name="is_voucher_code" value="1"> Voucher Code</label>
					<br>
								<label class="radio-inline" style="font-weight: bold;"><input type="checkbox" name="is_bank_card_promo" value="1"> Bank Card Promotions</label>
							...
							<div class="col-lg-12">
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										<thead>
										    <tr>
                                                <th colspan="6"><input type="checkbox" style="" name="enable_foreign_market" id="enable_foreign_market" value="1" <?php if($product->is_foreign_market == 1) echo "checked"; ?>> Foreign Market</th>
                                            </tr>
											<tr>
												<th>No.</th>
												<th>Label</th>
											...
											<tr class="price_option">
												...
												<td class="col-xs-3">
													<div class="form-group">
														...
														<div class="col-sm-10">
															{{ Form::textarea('price[][label]', null, ['class' => 'form-control','id' => 'enPriceLabel','placeholder' => 'English',rows=>'10']) }}
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															{{ Form::textarea('price[][label_cn]', null, ['class' => 'form-control summernote','id' => 'cnPriceLabel','placeholder' => 'Chinese',rows=>'10']) }}
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															{{ Form::textarea('price[][label_my]', null, ['class' => 'form-control summernote','id' => 'myPriceLabel','placeholder' => 'Bahasa',rows=>'10']) }}
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															{{ Form::textarea('price[][alternative_label_name]', $price->alternative_label_name, ['class' => 'form-control summernote','id' => 'alPriceLabel','placeholder' => 'Warehouse Label',rows=>'10']) }}
												...
												<td class="col-xs-3">
                                                                                                    <div id="main-price-box" class="local_price" >
													<div class="form-group">
														{{ Form::label('price', 'Actual:', ['class'=> 'col-sm-4 help-block']) }}
														<div class="col-sm-8">
															<input id="price_1" type="text" class="form-control text-right price_1 actual_price" name="price[][price]" placeholder="Actual Price">
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input id="price_promo_1" type="text" class="form-control text-right price_1 promo_price" name="price[][price_promo]" placeholder="Promotion">
...
<!--                                                                                                                    <div ng-repeat="x in suggestion_opt" class="col-md-12 suggestion-opt" >
						...
						<div class="form-group new-arrival-div" style="display: none;">
                            {{ Form::label('po_date', 'New Arrival Expired At', array('class' => 'col-lg-2 control-label')) }}
                            <div class="col-lg-2">
                                <div class="input-group" id="datetimepicker_from">
                                    <input id="new_arrival_expire" class="form-control" tabindex="1" name="new_arrival_expire" type="text" value="{{ Input::old('new_arrival_expire') }}">
