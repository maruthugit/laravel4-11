...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Product Package
                <span class="pull-right">
                    <a class="btn btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}product/package"><i class="fa fa-refresh"></i></a>
                    @if ( Permission::CheckAccessLevel(Session::get('role_id'), 2, 5, 'AND'))
                     <a class="btn btn-primary" title="" data-toggle="tooltip" href="/product/package/create"><i class="fa fa-plus"></i></a>
                    @endif
                </span>
            </h1>
        </div>
        ...
        @endif
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> Package Listing</h3>                    
                </div>
                <!-- /.panel-heading -->
...
@section('script')
    $('#dataTables-categories').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to('product/package/packages') }}",
        "order" : [[ 0, 'desc' ]],
        "columnDefs" : [{
            "targets" : "_all",
            "defaultContent" : ""
        ...
        "columns" : [
            { "data" : "0", "searchable" : false, "className" : "text-center" },
            { "data" : "1" },
            { "data" : "2" },
            { "data" : "3" },
