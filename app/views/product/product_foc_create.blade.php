                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" id="datetimepicker_from">
                                                            <input id="transaction_from" class="form-control" tabindex="1" name="start_date" type="text">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group" id="datetimepicker_to">
                                                            <input id="transaction_to" class="form-control" tabindex="1" name="end_date" type="text">
                                                            <span class="input-group-btn">
                                                                <button type="button" class="btn btn-default"><span class="glyphicon glyphicon-calendar"></span></button>
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="rule_code" id="rule_code" class="form-control">
                                                            <option>TMT</option>
                                                            <option>PDO</option>
                                                            <option>ALL</option>
                                                        </select>
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                <input type="checkbox" id="isActive" value="1" name="isActive"> Activate
                                                </label>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <div class="page-header">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <input id="foc_limit_qty" class="form-control" tabindex="1" name="foc_limit_qty" type="text">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="" id="sales_amount" name="sales_amount" aria-describedby="basic-addon1">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control" name="seller" id="seller" v-on:change="handleSeller(SellerList)" v-model="SellerList">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="page-header">
                                            ...
                                            <hr>
                                            <button type="button" v-on:click="saveFOC()" class="btn btn-default">Submit</button>
                                        ...
                                        <div class="media"> 
                                            ...
                                            <div class="media-body"> 
                                                ...
                                                <p>
                                                    ...
                                                    <ul>
                                                        <li>PDO - Per delivery order and match condition for any seller</li>
                                                        <li>TMT - Any transaction for selected seller</li>
                                                        <li>ALL - Any transactions are match to selected states</li>
                                                    </ul>
                                                </p>
                                            </div> 
                                        </div> 
