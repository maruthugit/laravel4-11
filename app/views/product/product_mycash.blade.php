...
@section('title') MyCashOnline @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">MyCash Online Store
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> Product List <span class="text-primary">[NEW ARRIVALS]</span></h3>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> Product List <span class="text-primary">[HOT SALES]</span></h3>
                </div>
                <div class="panel-body">
                    <div class="col-md-6" style="    border-right: dashed 1px;border-color: #e0d9d9;">
                        <div class="table-responsive" style="overflow-x: none">
...
@section('inputjs')
    ...
    function removeCampaignProduct(product_campaign_id){
        ...
        $.ajax({
            method: "POST",
            url: "/mycashonline/removeproduct",
            dataType:'json',
            data: {
                'product_campaign_id':product_campaign_id
            },
