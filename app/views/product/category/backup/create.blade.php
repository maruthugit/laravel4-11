        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        {{ Form::open(array('route' => 'product.category.store', 'class' => 'form-horizontal', 'files'=> true)) }}
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									{{ Form::select('category_parent', array('0' => 'None') + $category_options, null, ['class' => 'form-control']) }}
								</div>
							</div>
