...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Pantry Delivering Convenience (Office Pantry)
...
@section('inputjs')
    ...
    function removeCampaignProduct(product_campaign_id){
        ...
        $.ajax({
            method: "POST",
            url: "/officepantry/removeproduct",
            dataType:'json',
            data: {
                'product_campaign_id':product_campaign_id
            },
