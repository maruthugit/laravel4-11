   ...
   $(document).ready(function () {
         ...
         $("#datepicker").datepicker({
            ...
            onSelect: function () {
                ...
                var datepicker2Date = datepicker2.datepicker('getDate');
                //difference in days. 86400 seconds in day, 1000 ms in second
                var dateDiff = (datepicker2Date - minDate)/(86400 * 1000);
                
                startDate.setDate(startDate.getDate() + 30);
                if (datepicker2Date == null || dateDiff < 0) {
        ...
        @endif
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        {{ Form::open(array('url'=>'report/transaction', 'id' => 'add', 'class' => 'form-horizontal', 'files' => true)) }}
                        ...
                        {{ Form::label('email', 'Email To', array('class'=> 'col-lg-2 control-label')) }}
                             <div class="col-lg-3">
                                {{Form::text('email', '', array('required'=>'required', 'placeholder' => 'abc@tmgrocer.com, 123@tmgrocer.com', 'class'=>'form-control'))}}
                        ...
                        {{ Form::label('company', 'Company', array('class'=> 'col-lg-2 control-label')) }}
                            <div class="col-lg-2">
                                {{ Form::select('company', array('0' => 'tmGrocer'), '0', ['class' => 'form-control']) }}
                            </div>
                        </div>
                        ...
                        {{ Form::label('status', 'Status', array('class'=> 'col-lg-2 control-label')) }}
                          ...
                          <div class="form-group @if ($errors->has('status')) has-error @endif">
                        {{ Form::label('buyer_username', 'Platform', array('class'=> 'col-lg-2 control-label')) }}
                            <div class="col-lg-10">
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('prestomall', '1', true) }} {{ Prestomall }}
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('11Street', '1', true) }} 11Street
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('lazada', '1',true) }} {{ Lazada }}
                                    </label>
                                </div>    
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('Qoo10', '1',true) }} {{ Qoo10 }}
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('shopee', '1',true) }} {{ Shopee }}
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('astrogo', '1',true) }} Astro Go Shop
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('vettons', '1',true) }} {{ Vettons }}
                                    </label>
                                </div>
                                
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('jocom', '1',true) }} {{ jocom }}
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('fnlife', '1',true) }} F&N Life
                                    </label>
                                </div>
                                <div class="col-lg-2">
                                    <label class="checkbox-inline">
                                    {{ Form::checkbox('fntiktok', '1',true) }}  F&N TikTok
                                    </label>
                                </div>
                        ...
                        <div class="form-group @if ($errors->has('agent')) has-error @endif">
                            {{ Form::label('agent_code', '[Optional] Agent', ['class' => 'col-lg-2 control-label']) }}
                            <div class="col-lg-4">
                                {{ Form::text('agent', Input::get('agent'), ['autocomplete' => 'off', 'class' => 'form-control', 'id' => 'agent', 'placeholder' => 'Agent Code']) }}
                                <p class="help-block">Blank for all</p>
                                <p class="help-block" for="inputError">{{ $errors->first('agent') }}</p>
                            </div>
                        </div>

                        <div class="form-group @if ($errors->has('product')) has-error @endif">
                        {{ Form::label('product_name', '[Optional] Product', array('class'=> 'col-lg-2 control-label')) }}
                            <div class="col-lg-2">
                                {{ Form::select('breakdown', array('0' => 'No Breakdown ', '1' => 'Breakdown By Product'), "0", ['class' => 'form-control']) }}
                            </div>
                            <div class="col-lg-4">
                                {{ Form::text('product', Input::get('product'), ['autocomplete' => 'off', 'class' => 'form-control', 'id' => 'product', 'placeholder' => 'Product SKU']) }}
                                <p class="help-block">Blank for all, or use ',' for multi-product.</p>
                        ...
                        {{ Form::label('seller_name', '[Optional] Seller', array('class'=> 'col-lg-2 control-label')) }}
                             <div class="col-lg-4">
                                {{ Form::text('seller', Input::get('seller'), ['autocomplete' => 'off', 'class' => 'form-control', 'id' => 'seller', 'placeholder' => 'Seller Name or ID']) }}
                                <div id="sellerAutoComplete" class="list-group autocomplete"></div>
                                <p class="help-block">Blank for all [Only workable if select Breakdown By Product]</p>
                        ...
                        <div class="form-group @if ($errors->has('special_msg')) has-error @endif">
                        {{ Form::label('special_msg', '[Optional] Special Message', array('class'=> 'col-lg-2 control-label')) }}
                            <div class="col-lg-4">
                                {{ Form::select('special_msg', array('0' => 'Not Applicable', '1' => 'Transaction with Special Message only'), "0", ['class' => 'form-control']) }}
                            </div>
                        </div>
						
						<!-- <div class="form-group @if ($errors->has('gateway')) has-error @endif">
                        {{ Form::label('gateway', '[Optional] Payment Gateway', array('class'=> 'col-lg-2 control-label')) }}
                            <div class="col-lg-2">
                                {{ Form::select('gateway', array('0' => 'Not Applicable', '1' => 'ManagePay', '2' => 'MOLPay', '3' => 'PayPal'), '0', ['class' => 'form-control']) }}
                            </div>
                        </div> -->
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($job->status == 0)
                                                            <a class="btn btn-large btn-primary" title="" data-toggle="tooltip" href="{{asset('/')}}process/report/{{$job->id}}/?type=trans">Process Now</a>
...
@section('script')
    ...
    document.getElementById("region_country_id").selectedIndex = "1";
