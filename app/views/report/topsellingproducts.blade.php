...
@section('title') TopSellingProducts @stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Top Selling Products by Seller
        ...
        @endif
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i>Top Selling Products Report </h3>                    
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                       <div class="col-lg-12">
                        {{ Form::open(array('url'=>'report/generatetopselling', 'id' => 'add', 'class' => 'form-horizontal', 'files' => true)) }}
