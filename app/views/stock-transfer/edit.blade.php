...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            {{ Form::open(array('url'=>'/stock-transfer/update/'.$stock_transfer->id, 'class' => 'form-horizontal')) }}
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            {{ Form::label('st_no', 'Stock Transfer No', array('class' => 'col-lg-2 control-label')) }}
                            <div class="col-lg-3">
                                <p class="form-control-static"><?php
                                        ...
                                        ?>
                                        {{ HTML::link('stock-transfer/files/'.$encrypted, $stock_transfer->st_no, array('target'=>'_blank')) }}
                        ...
                        <div class="form-group required {{ $errors->first('seller_id', 'has-error') }}">
                            ...
                            <input type="hidden" id="seller_id" name="seller_id" value="{{$stock_transfer->seller_id}}">
                            <div class="col-lg-3">
                                <div class="input-group" id="seller_display">
                                <input type="text" id="seller" name="seller" class="form-control" value="{{$stock_transfer->seller_name}}" readonly>
                                <span class="input-group-btn">
                        ...
                        <div class='form-group'>
                            ...
                            <div class="col-lg-4">
                            {{ Form::textarea('remark', $stock_transfer->remark, array('class'=> 'form-control', 'autofocus' => 'autofocus')) }}
...
@section('script')
    ...
    $(document).on("click", "#deleteItem", function(e) {
     ...
     $(document).ready(function(){
        var sdefault=<?php echo $newseller;?>;
        if(sdefault=='0'){
        ...
        if(sdefault=="0"){
          $('#seller_display').html('<b>Seller Name:</b><input type="text" class="form-control" name="new_seller_name" id="new_seller_name" style="margin-bottom: 15px" value="{{$stock_transfer->newseller_name}}"><br><b>Address 1:</b><input type="text" class="form-control" name="address_1" style="margin-bottom: 15px" id="address_1" value="{{$stock_transfer->address_1}}"><br><b>Address 2:</b><input type="text" class="form-control" name="address_2" style="margin-bottom: 15px" id="address_2" value="{{$stock_transfer->address_2}}"><br><b>Postcode:</b><input type="text" class="form-control" name="postcode" style="margin-bottom: 15px" id="postcode" value="{{$stock_transfer->postcode}}"><br><b>City:</b><input type="text" class="form-control" name="city" style="margin-bottom: 15px" id="city" value="{{$stock_transfer->city}}"><br><b>State:</b><input type="text" class="form-control" name="state" style="margin-bottom: 15px" id="state" value="{{$stock_transfer->state}}"><br><b>Tel Number:</b><input type="text" class="form-control" name="tel_num" style="margin-bottom: 15px" id="tel_num" value="{{$stock_transfer->tel_num}}"><br><b>Attn:</b><input type="text" class="form-control" name="attn" style="margin-bottom: 15px" id="attn" value="{{$stock_transfer->attn}}">');
        }else{
          $('#seller_display').html('<input type="text" id="seller" name="seller" class="form-control" value="{{$stock_transfer->seller_name}}" readonly><span class="input-group-btn"><button class="btn btn-primary selectSellerBtn" id="selectSellerBtn"  type="button" href="/purchase-order/seller-list"><i class="fa fa-plus"></i> Seller</button></span>');
           $('#selectSellerBtn').colorbox({
        iframe:true, width:"90%", height:"90%",
        onClosed: function() {
            localStorage.clear();
       ...
       $('#address_check').val("1");
        ...
        $('#address_check').val("0");
          ...
          $('#seller_id').val("<?php echo $stock_transfer->seller_id?>");
          }
        $('#selectSellerBtn').colorbox({
        iframe:true, width:"90%", height:"90%",
        onClosed: function() {
