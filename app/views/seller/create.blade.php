...
<div id="page-wrapper">
    ...
    {{ Form::open(array('url' => 'seller/store/' , 'class' => 'form-horizontal', 'files' => true)) }}
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('company_reg_num', null, ['placeholder' => 'Company Registration No', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                        {{ Form::text('gst_reg_num', null, ['placeholder' => 'GST Registration No', 'id' => 'gstnumCheck', 'class' => 'form-control']) }}
                        <input type="checkbox" value="1" id="gstCheck" name="non_gst"> Non GST Registered
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('tel_num', null, ['placeholder' => 'Telephone No', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('address1', null, ['placeholder' => 'Street Address', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('address2', null, ['placeholder' => 'Street Address 2', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::email('email2', null, ['placeholder' => 'Email - 2', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::email('email3', null, ['placeholder' => 'Email - 3', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('pic_full_name', null, array('class' => 'form-control') ) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('ic_no', null, ['placeholder' => 'NRIC/Passport', 'class' => 'form-control']) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4"> 
                        <input type="checkbox" value="1" id="notification" name="notification"> 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('bank_acc_no', null, array('class' => 'form-control') ) }}
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4">
                    {{ Form::text('bank_type', null, array('class' => 'form-control') ) }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-body">
            <div class="col-lg-12">
                ...
                <div class='form-group'>
                    ...
                    <div class="col-lg-4" style="padding-top: 5px;">
                        <input name="business_method" type="radio" value="1" id="is_cosignment" checked="checked"> Buy Off
                        <input name="business_method" type="radio" value="2" id="is_cosignment"> Consignment
                    </div>
                </div>
                <div class='form-group'>
                    ...
                    <div class="col-lg-10">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 320px; height: 320px;">
                                {{ HTML::image('images/no_images.jpg') }}   
                            </div>
