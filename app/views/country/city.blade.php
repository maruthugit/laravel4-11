...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">State : {{ $state->name }} 
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i> City Listing</h3>                    
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <div class="table-responsive" style="overflow-x: none">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-cities">
                        <thead>
                            <tr>
...
@section('script')
    $('#dataTables-cities').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ URL::to("country/cities/$state->id") }}",
        "order" : [[ 0, 'asc' ]],
        "columnDefs" : [{
            "targets" : "_all",
            "defaultContent" : ""
