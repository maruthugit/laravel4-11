...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            {{ Form::open(array('url'=>'/admingrn/pbxgeneratezip', 'class' => 'form-horizontal')) }}
...
<form id="complete_form" name="complete_form" action="/admingrn/pbxcomplete" method="post">
