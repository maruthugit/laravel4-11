...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add New GRN</h1>
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      {{ Form::open(['url' => 'grn/store', 'method' => 'post']) }}
                    ...
                    <div class="form-group required {{ $errors->first('po_no', 'has-error') }}">
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="cell-small col-sm-2 text-center">Stock In Qty</th>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                ...
                                <?php 
                                if (in_array(Session::get('username'), array("joshua","agnes","maruthu","sharifah","quenny","asif","amyng","shinie"))) {
                                ?>
...
$(document).on("change paste keyup",'.stockin_qty', function() {
   var total_qty=$(this).parent().prev('td').find("input[type=number]").val();
   var current_qty=$(this).val();
   var c= parseInt(current_qty);
   var t= parseInt(total_qty);
   if(t<c){
       alert('Stock In Quantity cant be more then quantity!');
       $(this).val(total_qty)
       return false;
   }
    ...
    $('#selectPOBtn').colorbox({
        ...
        onClosed:function(){
            ...
            $.ajax({
                ...
                success:function(response) {
                    ...
                    for (i = 0; i < response.length; i++) {
                        $('#ptb').append('<tr id="'+i+'" class="product">\
                                ...
                                <td class="hidden-xs hidden-sm col-xs-1"><input type="number" class="form-control text-center stockin_qty" name="stockin_qty[]" value="0"></td>\
             ...
             $.ajax({
                url:'/grn/ajaxfetchseller/' + localStorage.data0,
                type:'get',
                processData: false,
                contentType: false,
                success:function(response) {
             ...
             $.ajax({
                url:'/grn/ajaxfetchwarehouse/' + localStorage.data0,
                type:'get',
                processData: false,
                contentType: false,
                success:function(response) {
