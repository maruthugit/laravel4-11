                ...
                @endif
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-list"></i> Users Listing</h3>                    
                        </div>
                        <!-- /.panel-heading -->
        ...
        $(document).ready(function() {
            $('#dataTables-users').dataTable({
                ...
                "columns" : [
                    ...
                    { "data" : "1", "className" : "col-sm-3" },
                    { "data" : "2", "className" : "col-sm-3" },              
                    { "data" : "3", "orderable" : false, "searchable" : false, "className" : "text-center col-sm-1"},                  
                ],
            ...
            $(document).on("click", "#selectItem", function() {
                ...
                parent.$('input#user').val(localStorage.data2);
