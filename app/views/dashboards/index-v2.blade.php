        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="statistics col-lg-3 col-12">
              ...
              <div class="daily-feeds card bg-white">
                <div class="card-header">
                  <h3 class="h4 title-green top-10-prod-curweek">Top 10 Products This Week</h3>
                </div>
                <div class="card-body no-padding">
                  <div class="loader procat-loader">
                      <div class="loader-inner"></div>
                  ...
                  <div class="top-prodcuts-this-week"></div>
                </div>
              </div>
              ...
              <div class="daily-feeds card bg-white">
                <div class="card-header">
                  <h3 class="h4 title-green top-10-prod-lastweek">Top 10 Products Last Week</h3>
                </div>
                <div class="card-body no-padding">
                  <div class="loader procat-loader">
                      <div class="loader-inner"></div>
              ...
              <div class="daily-feeds card bg-white">
                <div class="card-header">
                  <h3 class="h4 title-green top-5-cat">Top 10 Categories</h3>
                </div>
                <div class="card-body no-padding">
                  <div class="loader procat-loader">
                      <div class="loader-inner"></div>
              ...
              <div class="pie-chart bg-white card">
                <div class="card-header d-flex align-items-center">
                  ...
                  <h3 class="h4 title-green">Device Platform</h3>
                </div>
                <div class="card-body">
            ...
            <div class="chart col-lg-6 col-12">
              ...
              <div class="line-chart bg-white card no-padding">
                <div class="card-header d-flex align-items-center">
                  <h3 class="h4 title-green">Distribution Of Buyer By Region (Top 10 Regions)</h3>
                </div>
                <div class="card-body line-chart d-flex has-shadow">
                <div class="container">
