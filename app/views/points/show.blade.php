        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ Form::open(['url' => "points/{$point->id}", 'method'=> 'PATCH', 'class' => 'form-horizontal']) }}
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">ID</label>
                                <div class="col-lg-3">
                                    <p class="form-control-static">{{ $point->id }}</p>
                                </div>
                            </div>
                            <div class="form-group @if ($errors->has('type')) has-error @endif">
                                <label class="col-lg-2 control-label">Point</label>
                                <div class="col-lg-3">
                                    {{ Form::text('type', $point->type, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group @if ($errors->has('earn_rate')) has-error @endif">
                                ...
                                <div class="col-lg-3">
                                    {{ Form::text('earn_rate', $point->earn_rate, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group @if ($errors->has('redeem_rate')) has-error @endif">
                                ...
                                <div class="col-lg-3">
                                    {{ Form::text('redeem_rate', $point->redeem_rate, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group @if ($errors->has('status')) has-error @endif">
                                ...
                                <div class="col-lg-3">
                                    {{ Form::select('status', $statusOptions, $point->status, ['class' => 'form-control']) }}
                            ...
                            <div class="form-group @if ($errors->has('deactivate')) has-error @endif">
                                ...
                                <div class="col-lg-3">
                                    <textarea id="deactivate" rows="5" name="deactivate" class="form-control">{{ $deactivate }}</textarea>
