...
class JocomFeaturedController extends BaseController
{
    ...
    public function getCampaignProduct(){
        ...
        $products = DB::table('jocom_featured_products AS JCP')
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = JocomFeaturedProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = JocomFeaturedProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $JocomFeaturedProducts = new JocomFeaturedProducts();
                $JocomFeaturedProducts->product_id = $product_id;
                $JocomFeaturedProducts->campaign_id = $campaign_id;
                $JocomFeaturedProducts->order_position = $totalProduct + 1;
                $JocomFeaturedProducts->created_by = Session::get('username');
                $JocomFeaturedProducts->updated_by = Session::get('username');
                $JocomFeaturedProducts->status = 1;
                $JocomFeaturedProducts->save();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = JocomFeaturedProducts::find($product_campaign_id);
    ...
    public function getAPICampaignProduct(){
        ...
        try{
            ...
            $campaign_id = 1;
            $Product = JocomFeaturedProducts::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = JocomFeaturedProducts::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function getCampaignUpdate(){
        ...
        try{
                ...
                $last_postition = JocomFeaturedProducts::max('order_position');
                ...
                JocomFeaturedProducts::swapOrderPosition($product_campaign_id, $order_position);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 2){
                ...
                $ProductAfter = JocomFeaturedProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = JocomFeaturedProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
    ...
    public function saveseq()
    {
        ...
        try{
            ...
            for ($i = 0; $i < count($product_campaign_ids); $i++) {
                ...
                JocomFeaturedProducts::swapOrderPosition($product_campaign_ids[$i], $order_positions[$i]);
            }
