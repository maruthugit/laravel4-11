...
class OfficepantryController extends BaseController
{
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = OfficePantryProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = OfficePantryProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $OfficePantryProducts = new OfficePantryProducts();
                $OfficePantryProducts->product_id = $product_id;
                $OfficePantryProducts->campaign_id = $campaign_id;
                $OfficePantryProducts->order_position = $totalProduct + 1;
                $OfficePantryProducts->created_by = Session::get('username');
                $OfficePantryProducts->updated_by = Session::get('username');
                $OfficePantryProducts->status = 1;
                $OfficePantryProducts->save();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = OfficePantryProducts::find($product_campaign_id);
    ...
    public function getAPICampaignProduct(){
        ...
        try{
            ...
            $campaign_id = 1;
            $Product = OfficePantryProducts::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = OfficePantryProducts::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 1){
                ...
                $ProductAfter = OfficePantryProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = OfficePantryProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
