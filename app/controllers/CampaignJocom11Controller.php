...
class CampaignJocom11Controller extends BaseController
{
    ...
    public function getCampaignProduct(){
        ...
        $products = DB::table('jocom_campaignjocomeleven11_products AS JCP')
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = CampaignJocom11Products::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = CampaignJocom11Products::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $CampaignJocom11Products = new CampaignJocom11Products();
                $CampaignJocom11Products->product_id = $product_id;
                $CampaignJocom11Products->campaign_id = $campaign_id;
                $CampaignJocom11Products->order_position = $totalProduct + 1;
                $CampaignJocom11Products->created_by = Session::get('username');
                $CampaignJocom11Products->updated_by = Session::get('username');
                $CampaignJocom11Products->status = 1;
                $CampaignJocom11Products->save();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = CampaignJocom11Products::find($product_campaign_id);
    ...
    public function getAPICampaignProduct(){
        ...
        try{
            ...
            $campaign_id = 1;
            $Product = CampaignJocom11Products::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = CampaignJocom11Products::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function getCampaignUpdate(){
        ...
        try{
                ...
                $last_postition = CampaignJocom11Products::max('order_position');
                ...
                CampaignJocom11Products::swapOrderPosition($product_campaign_id, $order_position);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 2){
                ...
                $ProductAfter = CampaignJocom11Products::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = CampaignJocom11Products::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
    ...
    public function saveseq()
    {
        ...
        try{
            ...
            for ($i = 0; $i < count($product_campaign_ids); $i++) {
                ...
                CampaignJocom11Products::swapOrderPosition($product_campaign_ids[$i], $order_positions[$i]);
            }
