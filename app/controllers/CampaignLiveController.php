...
class CampaignLiveController extends BaseController
{
    ...
    public function getCampaignProduct(){
        ...
        $products = DB::table('jocom_livestreaming_products AS JCP')
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = CampaignLiveProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = CampaignLiveProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $CampaignLiveProducts = new CampaignLiveProducts();
                $CampaignLiveProducts->product_id = $product_id;
                $CampaignLiveProducts->campaign_id = $campaign_id;
                $CampaignLiveProducts->order_position = $totalProduct + 1;
                $CampaignLiveProducts->created_by = Session::get('username');
                $CampaignLiveProducts->updated_by = Session::get('username');
                $CampaignLiveProducts->status = 1;
                $CampaignLiveProducts->save();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = CampaignLiveProducts::find($product_campaign_id);
    ...
    public function getAPICampaignProduct(){
        ...
        try{
            ...
            $campaign_id = 1;
            $Product = CampaignLiveProducts::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = CampaignLiveProducts::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function getCampaignUpdate(){
        ...
        try{
                ...
                $last_postition = CampaignLiveProducts::max('order_position');
                ...
                CampaignLiveProducts::swapOrderPosition($product_campaign_id, $order_position);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 2){
                ...
                $ProductAfter = CampaignLiveProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = CampaignLiveProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
    ...
    public function saveseq()
    {
        ...
        try{
            ...
            for ($i = 0; $i < count($product_campaign_ids); $i++) {
                ...
                CampaignLiveProducts::swapOrderPosition($product_campaign_ids[$i], $order_positions[$i]);
            }
