...
class CampaignBoost11Controller extends BaseController
{
    ...
    public function getCampaignProduct(){
        ...
        $products = DB::table('jocom_campaignboosteleven11_products AS JCP')
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = CampaignBoost11Products::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = CampaignBoost11Products::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $CampaignBoost11Products = new CampaignBoost11Products();
                $CampaignBoost11Products->product_id = $product_id;
                $CampaignBoost11Products->campaign_id = $campaign_id;
                $CampaignBoost11Products->order_position = $totalProduct + 1;
                $CampaignBoost11Products->created_by = Session::get('username');
                $CampaignBoost11Products->updated_by = Session::get('username');
                $CampaignBoost11Products->status = 1;
                $CampaignBoost11Products->save();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = CampaignBoost11Products::find($product_campaign_id);
    ...
    public function getAPICampaignProduct(){
        ...
        try{
            ...
            $campaign_id = 1;
            $Product = CampaignBoost11Products::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = CampaignBoost11Products::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function getCampaignUpdate(){
        ...
        try{
                ...
                $last_postition = CampaignBoost11Products::max('order_position');
                ...
                CampaignBoost11Products::swapOrderPosition($product_campaign_id, $order_position);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 2){
                ...
                $ProductAfter = CampaignBoost11Products::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = CampaignBoost11Products::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
    ...
    public function saveseq()
    {
        ...
        try{
            ...
            for ($i = 0; $i < count($product_campaign_ids); $i++) {
                ...
                CampaignBoost11Products::swapOrderPosition($product_campaign_ids[$i], $order_positions[$i]);
            }
