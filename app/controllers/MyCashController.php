...
class MyCashController extends BaseController
{
    ...
    public function getCampaignProductNew(){
        ...
        try{
            $campaign_id = Input::get('campaign_id');
            $Products = MyCashProducts::getCampaignProduct(2);
            $data['products'] = $Products;
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = MyCashProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = MyCashProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $BoostOnlinestoreProducts = new MyCashProducts();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = MyCashProducts::find($product_campaign_id);
    ...
    public function getAPICampaignProduct($campaign_id){
        ...
        try{
            ...
            // $campaign_id = Input::get('campaign_id');
            $Product = MyCashProducts::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            // $Product = MyCashProducts::getCampaignProductInfo($campaign_id,$productID);
            $Product = MyCashProducts::getCampaignProductInfo($productID);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 1){
                ...
                $ProductAfter = MyCashProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = MyCashProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
