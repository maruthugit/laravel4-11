...
class CampaignController extends BaseController
{
    ...
    public function getCampaignProduct(){
        ...
        $products = DB::table('jocom_campaign_products AS JCP')
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = CampaignProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = CampaignProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $CampaignProducts = new CampaignProducts();
                $CampaignProducts->product_id = $product_id;
                $CampaignProducts->campaign_id = $campaign_id;
                $CampaignProducts->order_position = $totalProduct + 1;
                $CampaignProducts->created_by = Session::get('username');
                $CampaignProducts->updated_by = Session::get('username');
                $CampaignProducts->status = 1;
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = CampaignProducts::find($product_campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = CampaignProducts::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function getCampaignUpdate(){
        ...
        try{
                ...
                $last_postition = CampaignProducts::max('order_position');
                ...
                CampaignProducts::swapOrderPosition($product_campaign_id, $order_position);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 2){
                ...
                $ProductAfter = CampaignProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = CampaignProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
    ...
    public function saveseq()
    {
        ...
        try{
            ...
            for ($i = 0; $i < count($product_campaign_ids); $i++) {
                ...
                CampaignProducts::swapOrderPosition($product_campaign_ids[$i], $order_positions[$i]);
            }
    ...
    public function getAPIVoucherProduct(){
        // echo 'In';
        $isError = 0;
        $RespStatus = 1;
        $message = "";
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPIVoucherProductInfo(){
        ...
        try{
            ...
            $campaign_id = 1;
            $productID = Input::get('product_id');
            $Product = Api::getAPIProductInfo($productID);
