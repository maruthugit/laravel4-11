...
class BoostOnlinestoreController extends BaseController
{
     ...
     * @Return  : JSON
     */
    public function getCampaignProductNew(){
        ...
        try{
            $campaign_id = Input::get('campaign_id');
            $Products = BoostOnlinestoreProducts::getCampaignProduct(2);
            $data['products'] = $Products;
    ...
    public function addCampaignProduct(){
        ...
        try{
            ...
            $totalProduct = BoostOnlinestoreProducts::getTotalCampaignProduct($campaign_id);
            // Check if the product already added
            
            $productInfo = BoostOnlinestoreProducts::findProduct($product_id);

            if(count($productInfo) <= 0){
                
                $BoostOnlinestoreProducts = new BoostOnlinestoreProducts();
    ...
    public function removeCampaignProduct(){
        ...
        try{
            ...
            $Product = BoostOnlinestoreProducts::find($product_campaign_id);
    ...
    public function getAPICampaignProduct($campaign_id){
        ...
        try{
            ...
            // $campaign_id = Input::get('campaign_id');
            $Product = BoostOnlinestoreProducts::getAPICampaignProduct($campaign_id);
...
//                        "ProductPromoPriceFinal" =>number_format( $final_price_promo, 2, '.', ''),
    ...
    public function getAPICampaignProductInfo(){
        ...
        try{
            ...
            $Product = BoostOnlinestoreProducts::getCampaignProductInfo($campaign_id,$productID);
    ...
    public function moveProductOrder(){
        ...
        try{
            ...
            if($action == 1){
                ...
                $ProductAfter = BoostOnlinestoreProducts::findProductOrderAfter($ProductPosition,$Product->campaign_id); 
                ...
                $ProductBefore = BoostOnlinestoreProducts::findProductOrderBefore($ProductPosition,$Product->campaign_id); 
