            ...
            Mail::send('emails.blank', $body, function($message) use ($subject, $mail, $attach)
                {
                    ...
                    if ($test == 'test'){
                    $message->cc(["maruthujocom@gmail.com", "maruthu13@gmail.com"]);
                    }else{
                        $message->cc(["sclim@jocom.my", "asif@jocom.my", "joshua.sew@jocom.my","agnes.chua@jocom.my","choong@jocom.my","gladys.khoo@jocom.my"]);
                    }
