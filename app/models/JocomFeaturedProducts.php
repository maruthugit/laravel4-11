...
class JocomFeaturedProducts extends Eloquent
{
    protected $table = 'jocom_featured_products';
    
    
    public static function getTotalCampaignProduct($campaign_id){
        
        return DB::table('jocom_featured_products')
    ...
    public static function getCampaignProduct($campaign_id){
        ...
        return DB::table('jocom_featured_products AS JCP')
