...
class CampaignJocom11Products extends Eloquent
{
    protected $table = 'jocom_campaignjocomeleven11_products';
    
    
    public static function getTotalCampaignProduct($campaign_id){
        
        return DB::table('jocom_campaignjocomeleven11_products')
    ...
    public static function getCampaignProduct($campaign_id){
        ...
        return DB::table('jocom_campaignjocomeleven11_products AS JCP')
