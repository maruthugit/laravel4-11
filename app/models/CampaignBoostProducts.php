...
class CampaignBoostProducts extends Eloquent
{
    protected $table = 'jocom_campaignboost_products';
    
    
    public static function getTotalCampaignProduct($campaign_id){
        
        return DB::table('jocom_campaignboost_products')
...
//    }
    ...
    public static function getCampaignProduct($campaign_id){
        ...
        return DB::table('jocom_campaignboost_products AS JCP')
