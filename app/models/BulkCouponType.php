...
class BulkCouponType extends Eloquent implements UserInterface, RemindableInterface {
     ...
     * @var string
     */
    protected $table = 'jocom_coupon_bulk_type';

    public function scopeGet_list($query, $id) 
    {
        $listtype = BulkCouponType::select('related_id')->where('coupon_id', '=', $id)->get();
        $couponlist = array();
