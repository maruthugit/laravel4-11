...
class CrossborderProducts extends Eloquent
{
    protected $table = 'jocom_crossborder_products';
    
    
    public static function getTotalCampaignProduct($campaign_id){
        
        return DB::table('jocom_crossborder_products')
...
//    }
    ...
    public static function getCampaignProduct($campaign_id){
        ...
        return DB::table('jocom_crossborder_products AS JCP')
    ...
    public static function findProductOrderAfter($position_product_id,$campaign_id,$status = 1){
        ...
        return CrossborderProducts::where('order_position',">", $position_product_id)
                    ->where('status', $status)
                    ->where('campaign_id', $campaign_id)
                    ->first();
